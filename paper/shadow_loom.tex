...
model --- both are themselves \emph{graphical world models} in
their own right, since each defines a typed dynamics over the
shared graph --- in the spirit of a game engine that pairs a
physics simulator with a higher-level director. The first engine
is a \emph{causal physics} (a Pearl-style graphical world model of
cause and effect) grounded in Pearl's ladder of causation
