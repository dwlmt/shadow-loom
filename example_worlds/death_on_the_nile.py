...
world_state = WorldStateV1(
    ...
    entities={
        "ENT_POIROT": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_JACQUELINE",
                       ...
                       confidence=0.85, inertia=0.7, established_at_fabula=100, evidence_strength="strong"),
            ],
            state_timeline=[
                EntityStateSnapshot(fabula_time=400, triggered_by="EVT_BOARD_KARNAK",
                    location_id="LOC_KARNAK_LOUNGE"),
                EntityStateSnapshot(fabula_time=1100, triggered_by="EVT_REAL_PEARLS_RECOVERED",
                    beliefs_added=[
                        Belief(target_id="ENT_TIM",
                               perceived_state="professional pearl thief operating throughout Europe",
                               confidence=0.95, inertia=0.85, established_at_fabula=1100, evidence_strength="strong"),
                    ]),
                EntityStateSnapshot(fabula_time=1300, triggered_by="EVT_POIROT_SOLVES",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_SIMON",
                               ...
                               confidence=1.0, inertia=0.9, established_at_fabula=1300, evidence_strength="strong"),
                    ]),
            ],
        ),
        "ENT_LINNET": Entity(
            ...
            beliefs=[
                ...
                Belief(target_id="ENT_PENNINGTON",
                       ...
                       confidence=0.8, inertia=0.7, established_at_fabula=100, evidence_strength="moderate"),
            ],
            state_timeline=[
                EntityStateSnapshot(fabula_time=400, triggered_by="EVT_BOARD_KARNAK",
                    location_id="LOC_KARNAK_LOUNGE"),
                EntityStateSnapshot(fabula_time=900, triggered_by="EVT_LINNET_KILLED",
        ...
        "ENT_SIMON": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_JACQUELINE",
                       ...
                       confidence=1.0, inertia=0.9, established_at_fabula=50, evidence_strength="strong"),
            ...
            state_timeline=[
                EntityStateSnapshot(fabula_time=400, triggered_by="EVT_BOARD_KARNAK",
                    location_id="LOC_KARNAK_LOUNGE"),
                EntityStateSnapshot(fabula_time=850, triggered_by="EVT_FAKE_LEG_WOUND",
                    status="ill", location_id="LOC_KARNAK_BESSNER_CABIN"),
                EntityStateSnapshot(fabula_time=1400, triggered_by="EVT_JACQUELINE_SUICIDE_PACT",
        ...
        "ENT_JACQUELINE": Entity(
            ...
            state_timeline=[
                EntityStateSnapshot(fabula_time=400, triggered_by="EVT_BOARD_KARNAK",
                    location_id="LOC_KARNAK_LOUNGE"),
                EntityStateSnapshot(fabula_time=950, triggered_by="EVT_LOUISE_KILLED",
        ...
        "ENT_RACE": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_RICHETTI",
                       ...
                       confidence=0.85, inertia=0.7, established_at_fabula=600, evidence_strength="moderate"),
            ],
        ),
        "ENT_LOUISE": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_SIMON",
                       ...
                       confidence=0.85, inertia=0.5, established_at_fabula=900, evidence_strength="strong"),
            ],
            state_timeline=[
                EntityStateSnapshot(fabula_time=950, triggered_by="EVT_LOUISE_KILLED",
                    status="dead"),
        ...
        "ENT_PENNINGTON": Entity(
            ...
            state_timeline=[
                EntityStateSnapshot(fabula_time=600, triggered_by="EVT_BOULDER",
                ...
                EntityStateSnapshot(fabula_time=1100, triggered_by="EVT_REAL_PEARLS_RECOVERED",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_POIROT",
                               ...
                               confidence=0.9, inertia=0.7, established_at_fabula=1100, evidence_strength="strong"),
                    ]),
            ],
        ),
        ...
        "ENT_OTTERBOURNE": Entity(
            ...
            beliefs=[],
            state_timeline=[
                EntityStateSnapshot(fabula_time=1000, triggered_by="EVT_OTTERBOURNE_KILLED",
        ...
        "ENT_RICHETTI": Entity(
            ...
            beliefs=[],
            state_timeline=[
                EntityStateSnapshot(fabula_time=1150, triggered_by="EVT_RACE_IDS_RICHETTI",
                    traits={
                        "academic_cover": TraitVector(value=0.1, inertia=0.4, evidence_strength="strong"),
                    }),
                EntityStateSnapshot(fabula_time=1380, triggered_by="EVT_ARRESTS",
        ...
        "ENT_BESSNER": Entity(
            ...
            beliefs=[],
            state_timeline=[
                EntityStateSnapshot(fabula_time=830, triggered_by="EVT_FAKE_LEG_WOUND",
                    location_id="LOC_KARNAK_BESSNER_CABIN",
                    beliefs_added=[
                        Belief(target_id="ENT_SIMON",
                               perceived_state="genuinely wounded patient under my care",
                               confidence=0.85, inertia=0.6, established_at_fabula=830, evidence_strength="strong"),
                    ]),
                EntityStateSnapshot(fabula_time=1300, triggered_by="EVT_POIROT_SOLVES",
    ...
    # ── EVENTS ──────────────────────────────────────────────────────────
    events=[
        EventNode(id="EVT_LINNET_STEALS_SIMON", fabula_time=50, syuzhet_index=2,
        ...
        EventNode(id="EVT_HONEYMOON_STALKING", fabula_time=100, syuzhet_index=3,
        ...
        EventNode(id="EVT_POIROT_REFUSES_LINNET", fabula_time=200, syuzhet_index=1,
        ...
        EventNode(id="EVT_BOARD_KARNAK", fabula_time=400, syuzhet_index=4,
        ...
        EventNode(id="EVT_BOULDER", fabula_time=600, syuzhet_index=5,
        ...
        EventNode(id="EVT_RACE_BOARDS", fabula_time=700, syuzhet_index=6,
        ...
        EventNode(id="EVT_LOUNGE_SHOOTING", fabula_time=800, syuzhet_index=7,
        ...
        EventNode(id="EVT_FAKE_LEG_WOUND", fabula_time=830, syuzhet_index=8,
        ...
        EventNode(id="EVT_LINNET_KILLED", fabula_time=900, syuzhet_index=9,
        ...
        EventNode(id="EVT_PISTOL_THROWN", fabula_time=920, syuzhet_index=10,
        ...
        EventNode(id="EVT_LOUISE_BLACKMAILS", fabula_time=940, syuzhet_index=11,
        ...
        EventNode(id="EVT_LOUISE_KILLED", fabula_time=950, syuzhet_index=12,
        ...
        EventNode(id="EVT_PEARLS_RETURNED", fabula_time=970, syuzhet_index=13,
        ...
        EventNode(id="EVT_OTTERBOURNE_KILLED", fabula_time=1000, syuzhet_index=14,
        ...
        EventNode(id="EVT_PENNINGTON_CONFRONTED", fabula_time=1080, syuzhet_index=15,
        ...
        EventNode(id="EVT_REAL_PEARLS_RECOVERED", fabula_time=1100, syuzhet_index=16,
        ...
        EventNode(id="EVT_RACE_IDS_RICHETTI", fabula_time=1150, syuzhet_index=17,
        ...
        EventNode(id="EVT_POIROT_SOLVES", fabula_time=1300, syuzhet_index=18,
        ...
        EventNode(id="EVT_ARRESTS", fabula_time=1380, syuzhet_index=19,
        ...
        EventNode(id="EVT_JACQUELINE_SUICIDE_PACT", fabula_time=1400, syuzhet_index=20,
    ...
    causal_topology=[
        ...
        CausalEdge(source_id="EVT_HONEYMOON_STALKING", target_id="EVT_BOARD_KARNAK",
                   ...
                   causal_force=6.0, fabula_time=100, propagation_delay=300),
        ...
        CausalEdge(source_id="EVT_BOARD_KARNAK", target_id="EVT_LOUNGE_SHOOTING",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=400, propagation_delay=400),
        CausalEdge(source_id="EVT_LOUNGE_SHOOTING", target_id="EVT_FAKE_LEG_WOUND",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=800, propagation_delay=30),
        CausalEdge(source_id="EVT_FAKE_LEG_WOUND", target_id="EVT_LINNET_KILLED",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=10.0, fabula_time=830, propagation_delay=70),
        CausalEdge(source_id="EVT_LINNET_KILLED", target_id="EVT_PISTOL_THROWN",
                   ...
                   causal_force=8.0, fabula_time=900, propagation_delay=20),
        ...
        CausalEdge(source_id="EVT_OTTERBOURNE_KILLED", target_id="EVT_POIROT_SOLVES",
                   ...
                   causal_force=8.0, fabula_time=1000, propagation_delay=300),
        CausalEdge(source_id="EVT_PENNINGTON_CONFRONTED", target_id="EVT_POIROT_SOLVES",
                   ...
                   causal_force=4.0, fabula_time=1080, propagation_delay=220),
        CausalEdge(source_id="EVT_POIROT_SOLVES", target_id="EVT_ARRESTS",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=1300, propagation_delay=80),
        CausalEdge(source_id="EVT_ARRESTS", target_id="EVT_JACQUELINE_SUICIDE_PACT",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=10.0, fabula_time=1380, propagation_delay=20),
        ...
        CausalEdge(source_id="EVT_LINNET_STEALS_SIMON", target_id="ENT_JACQUELINE",
                   ...
                   causal_force=8.0, fabula_time=50,
        ...
        CausalEdge(source_id="EVT_LOUISE_KILLED", target_id="ENT_JACQUELINE",
                   causality_type="mutation", mechanism="psychological", evidence_strength="strong",
                   causal_force=8.0, fabula_time=950,
        ...
        CausalEdge(source_id="EVT_LOUISE_BLACKMAILS", target_id="ENT_SIMON",
                   causality_type="mutation_social", mechanism="betrayal", evidence_strength="strong",
                   causal_force=8.0, fabula_time=940,
        ...
        CausalEdge(source_id="EVT_ARRESTS", target_id="ENT_JACQUELINE",
                   ...
                   causal_force=8.0, fabula_time=1380,
        ...
        CausalEdge(source_id="LOC_KARNAK_BESSNER_CABIN", target_id="ENT_SIMON",
                   ...
                   causal_force=4.0, fabula_time=830),
        ...
        CausalEdge(source_id="WORLD_INHERITED_MONEY", target_id="EVT_PENNINGTON_CONFRONTED",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=5.0, fabula_time=1080),
        ...
        CausalEdge(source_id="WORLD_CLOSED_SOCIETY", target_id="EVT_LOUISE_BLACKMAILS",
                   causality_type="chain_reaction", mechanism="informational", evidence_strength="strong",
                   causal_force=6.0, fabula_time=940),
        ...
        CausalEdge(source_id="WORLD_DETECTIVE_EPISTEMOLOGY", target_id="EVT_PEARLS_RETURNED",
                   causality_type="chain_reaction", mechanism="epistemic", evidence_strength="strong",
                   causal_force=5.0, fabula_time=970),
    ...
    information_topology=[
        InformationEdge(source_id="ENT_JACQUELINE", target_ids=["ENT_POIROT"],
                        medium="aswan_terrace_confidence", is_encrypted=False,
        ...
        InformationEdge(source_id="ENT_LOUISE", target_ids=["ENT_SIMON"],
                        medium="hinted_blackmail", is_encrypted=True,
                        established_at_fabula=940, terminated_at_fabula=950,
                        discovered_at_syuzhet=11, evidence_strength="strong"),
        InformationEdge(source_id="ENT_OTTERBOURNE", target_ids=["ENT_POIROT", "ENT_RACE"],
                        medium="oral_denunciation", is_encrypted=False,
        ...
        InformationEdge(source_id="ENT_BOWERS", target_ids=["ENT_POIROT"],
                        medium="discreet_return", is_encrypted=False,
                        established_at_fabula=970, terminated_at_fabula=970,
                        discovered_at_syuzhet=13, evidence_strength="strong"),
        InformationEdge(source_id="OBJ_RED_INK_BOTTLE", target_ids=["ENT_POIROT"],
                        medium="forensic_smell", is_encrypted=False,
                        established_at_fabula=940, terminated_at_fabula=1300,
                        discovered_at_syuzhet=11, evidence_strength="strong"),
        InformationEdge(source_id="ENT_RACE", target_ids=["ENT_POIROT"],
                        medium="agitator_briefing", is_encrypted=True,
                        established_at_fabula=700, terminated_at_fabula=700,
                        discovered_at_syuzhet=6, evidence_strength="strong"),
        InformationEdge(source_id="OBJ_TRUSTEE_DOCUMENTS", target_ids=["ENT_POIROT"],
                        medium="document_inspection", is_encrypted=False,
                        established_at_fabula=1080, terminated_at_fabula=1080,
                        discovered_at_syuzhet=15, evidence_strength="strong"),
        InformationEdge(source_id="ENT_SIMON", target_ids=["ENT_POIROT"],
                        medium="confession", is_encrypted=False,
                        established_at_fabula=1320, terminated_at_fabula=1320,
    ...
    social_topology=[
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=0.95, inertia=0.55, evidence_strength="strong", last_updated_fabula=950),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_JACQUELINE", target_entity_id="ENT_SIMON",
            metrics={
                "affinity":      RelationshipMetric(value=1.0, inertia=0.6, evidence_strength="strong", last_updated_fabula=1000),
                "power_dynamic": RelationshipMetric(value=0.6, inertia=0.7, evidence_strength="strong", last_updated_fabula=950),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=-0.95, inertia=0.55, evidence_strength="strong", last_updated_fabula=100),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_LINNET", target_entity_id="ENT_JACQUELINE",
            metrics={
                "affinity": RelationshipMetric(value=-0.7, inertia=0.55, evidence_strength="strong", last_updated_fabula=100),
                "fear":     RelationshipMetric(value=0.5, inertia=0.2, evidence_strength="strong", last_updated_fabula=100),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.4, inertia=0.55, evidence_strength="moderate", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=-0.3, inertia=0.7, evidence_strength="moderate", last_updated_fabula=300),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=-0.4, inertia=0.55, evidence_strength="moderate", last_updated_fabula=400),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=-0.5, inertia=0.5, evidence_strength="strong", last_updated_fabula=940),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=0.4, inertia=0.55, evidence_strength="strong", last_updated_fabula=200),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                ...
                "affinity":      RelationshipMetric(value=0.5, inertia=0.55, evidence_strength="moderate", last_updated_fabula=400),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_VAN_SCHUYLER", target_entity_id="ENT_CORNELIA",
            metrics={
                "power_dynamic": RelationshipMetric(value=0.85, inertia=0.75, evidence_strength="strong", last_updated_fabula=400),
                "affinity":      RelationshipMetric(value=-0.2, inertia=0.55, evidence_strength="moderate", last_updated_fabula=400),
            },
        ),
    ],
)
