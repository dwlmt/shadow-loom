...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_LINNET_STEALS_SIMON", fabula_time=500, syuzhet_index=2,
                  ...
                  description="Linnet seduces Jacqueline's fiancé Simon away from her and marries him; in fact Simon and Jacqueline have together planned this as cover for Linnet's eventual murder.", at_location_id="LOC_ASWAN"),
        EventNode(id="EVT_HONEYMOON_STALKING", fabula_time=1000, syuzhet_index=3,
                  ...
                  description="Jacqueline conspicuously follows the Doyles' honeymoon to plant the public motive that will mask her conspiracy with Simon.", at_location_id="LOC_ASWAN"),
        EventNode(id="EVT_POIROT_REFUSES_LINNET", fabula_time=2000, syuzhet_index=1,
                  ...
                  description="In Aswan, Poirot refuses to be hired to deal with Jacqueline; he privately warns Jacqueline against opening her heart to evil.", at_location_id="LOC_ASWAN"),
        EventNode(id="EVT_BOARD_KARNAK", fabula_time=4000, syuzhet_index=4,
                  ...
                  description="The Doyles secretly board the Karnak to escape Jacqueline, who has anticipated and forestalled them.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_BOULDER", fabula_time=6000, syuzhet_index=5,
                  ...
                  description="At Abu Simbel a boulder is dislodged and nearly crushes Linnet — an independent attempt by Pennington that will later muddy the inquiry.", at_location_id="LOC_ABU_SIMBEL"),
        EventNode(id="EVT_RACE_BOARDS", fabula_time=7000, syuzhet_index=6,
                  ...
                  description="At Wadi Halfa Colonel Race boards in pursuit of an unidentified political agitator among the passengers.", at_location_id="LOC_WADI_HALFA"),
        EventNode(id="EVT_LOUNGE_SHOOTING", fabula_time=8000, syuzhet_index=7,
                  ...
                  description="In the lounge Jacqueline drunkenly fires her pistol at Simon and grazes him; she becomes hysterical and is led away by Cornelia, while Fanthorp finds the dropped pistol — only later to discover it gone.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_FAKE_LEG_WOUND", fabula_time=8300, syuzhet_index=8,
                  ...
                  description="Simon, with his pre-prepared red-ink wound, is carried to Dr Bessner's cabin where he establishes his alibi.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_LINNET_KILLED", fabula_time=9000, syuzhet_index=9,
                  ...
                  description="Slipping from the lounge between the two stagings, Simon enters Linnet's cabin and shoots her in the temple, then plants the red-ink bottle on the washstand.", at_location_id="LOC_KARNAK_BESSNER_CABIN"),
        EventNode(id="EVT_PISTOL_THROWN", fabula_time=9200, syuzhet_index=10,
                  ...
                  description="Simon wraps the pistol in Van Schuyler's stole as a silencer, fires the second shot into his own leg in the lounge, and throws the wrapped weapon overboard.", at_location_id="LOC_KARNAK_BESSNER_CABIN"),
        EventNode(id="EVT_LOUISE_BLACKMAILS", fabula_time=9400, syuzhet_index=11,
                  ...
                  description="Interviewed by Poirot in Bessner's cabin, Louise drops calculated hints meant for Simon: she saw him enter the cabin and proposes to be paid for her silence.", at_location_id="LOC_KARNAK_LOUISE_CABIN"),
        EventNode(id="EVT_LOUISE_KILLED", fabula_time=9500, syuzhet_index=12,
                  ...
                  description="Sent by Simon, Jacqueline stabs Louise to death in her cabin with a scalpel.", at_location_id="LOC_KARNAK_LOUISE_CABIN"),
        EventNode(id="EVT_PEARLS_RETURNED", fabula_time=9700, syuzhet_index=13,
                  ...
                  description="Miss Bowers quietly returns the pearls Van Schuyler stole; Poirot recognises them as imitation.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_OTTERBOURNE_KILLED", fabula_time=10000, syuzhet_index=14,
                  ...
                  description="Otterbourne, claiming to have seen Jacqueline enter Louise's cabin, comes to Bessner's room to denounce her; alerted by Simon's raised voice, Jacqueline shoots her dead from outside the door using Pennington's borrowed revolver.", at_location_id="LOC_KARNAK_LOUISE_CABIN"),
        EventNode(id="EVT_PENNINGTON_CONFRONTED", fabula_time=10800, syuzhet_index=15,
                  ...
                  description="Poirot extracts from Pennington the truth about the boulder, the speculation, and the trustee documents — but believes him innocent of the murders themselves.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_REAL_PEARLS_RECOVERED", fabula_time=11000, syuzhet_index=16,
                  ...
                  description="Poirot recovers the real pearls from Tim Allerton, exposing him as a professional thief who substituted the imitation.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_RACE_IDS_RICHETTI", fabula_time=11500, syuzhet_index=17,
                  ...
                  description="Race confirms Richetti is the political agitator he was sent to take.", at_location_id="LOC_WADI_HALFA"),
        EventNode(id="EVT_POIROT_SOLVES", fabula_time=13000, syuzhet_index=18,
                  ...
                  description="Poirot lays out to Race, Bessner and Cornelia the conspiracy: Simon and Jacqueline are the murderers; Simon confesses.", at_location_id="LOC_KARNAK_LOUNGE"),
        EventNode(id="EVT_ARRESTS", fabula_time=13800, syuzhet_index=19,
                  ...
                  description="Simon, Jacqueline and Richetti are placed under arrest pending disembarkation at Shellal.", at_location_id="LOC_WADI_HALFA"),
        EventNode(id="EVT_JACQUELINE_SUICIDE_PACT", fabula_time=14000, syuzhet_index=20,
                  ...
                  description="At Shellal Jacqueline shoots Simon and then herself with the second pistol Poirot had let her keep.", at_location_id="LOC_SHELLAL"),
        ...
        EventNode(
            ...
            at_location_id="LOC_ASWAN", content="Jacqueline is following us everywhere — would you, Monsieur Poirot, undertake to make her stop?",
        ...
        EventNode(
            ...
            at_location_id="LOC_ASWAN", content="Mademoiselle, do not open your heart to evil — for if you do, evil will come.",
        ...
        EventNode(
            ...
            at_location_id="LOC_WADI_HALFA", content="One of your fellow passengers is the agitator I've been chasing — I need your eyes as well as mine.",
            via_channel_id=None, truth_value="true",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_LOUNGE", content="You ruined my life, Simon Doyle — I told you what I'd do!",
            via_channel_id=None, truth_value="performative",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_LOUISE_CABIN", content="If, naturellement, I had been unable to sleep — if I had gone up on deck — I might have seen the assassin enter or leave the cabin... but as it is, I saw nothing.",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_LOUNGE", content="My patient took these in one of her spells — I beg you keep it confidential.",
            via_channel_id=None, truth_value="true",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_BESSNER_CABIN", content="I saw with my own eyes who went into that cabin — the murderer is...",
            via_channel_id=None, truth_value="true",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_BESSNER_CABIN", content="WHAT?! You actually saw the killer?",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_LOUNGE", content="Mes amis — Madame Doyle was killed by her husband, and the whole plan was Mademoiselle de Bellefort's.",
            via_channel_id=None, truth_value="true",
        ...
        EventNode(
            ...
            at_location_id="LOC_KARNAK_BESSNER_CABIN", content="All right, all right — yes, I shot her. Jackie planned every step. Don't let them hang Jackie.",
            via_channel_id=None, truth_value="true",
