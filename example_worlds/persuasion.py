...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_BROKEN_ENGAGEMENT", fabula_time=1000, syuzhet_index=1,
                  ...
                  description="Persuaded by Lady Russell that the match is imprudent for one so young, the nineteen-year-old Anne breaks her engagement to the unestablished Lieutenant Wentworth.", at_location_id="LOC_KELLYNCH_HALL"),
        EventNode(id="EVT_WAR_AND_PRIZE_MONEY", fabula_time=2000, syuzhet_index=2,
                  ...
                  description="Through the late Napoleonic Wars Wentworth captures French ships and accumulates roughly £25,000 in prize money, becoming a captain of fortune.", at_location_id="LOC_KELLYNCH_HALL"),
        EventNode(id="EVT_KELLYNCH_LET", fabula_time=3000, syuzhet_index=3,
                  ...
                  description="Pressed by debts, Sir Walter is persuaded to let Kellynch Hall to Admiral and Mrs Croft and remove with Elizabeth and Mrs Clay to Bath.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_ANNE_VISITS_UPPERCROSS", fabula_time=4000, syuzhet_index=4,
                  ...
                  description="Anne goes to Uppercross to nurse Mary, putting her in the social orbit of the Crofts and the returning Wentworth.", at_location_id="LOC_UPPERCROSS"),
        EventNode(id="EVT_WENTWORTH_RETURNS", fabula_time=4200, syuzhet_index=5,
                  event_type="outcome", actor_ids=["ENT_WENTWORTH"], target_ids=[],
                  description="Wentworth visits the Crofts at Kellynch and is drawn into the Musgrove circle, openly looking to marry.", at_location_id="LOC_UPPERCROSS"),
        EventNode(id="EVT_HAYTER_WITHDRAWS", fabula_time=5000, syuzhet_index=6,
                  ...
                  description="Hurt by Henrietta's apparent interest in Wentworth, Charles Hayter stops visiting Uppercross.", at_location_id="LOC_UPPERCROSS"),
        EventNode(id="EVT_WENTWORTH_LEARNS_ANNE_REFUSED_CHARLES", fabula_time=5500, syuzhet_index=7,
                  ...
                  description="Anne overhears Louisa telling Wentworth that Anne refused Charles Musgrove's first proposal, revealing Anne's continued unmarried state and disturbing Wentworth's settled view of her.", at_location_id="LOC_UPPERCROSS"),
        EventNode(id="EVT_LYME_VISIT", fabula_time=6000, syuzhet_index=8,
                  ...
                  description="The Uppercross party visits Captain Harville's family at Lyme Regis; Anne's looks attract the notice of a stranger who turns out to be William Elliot.", at_location_id="LOC_UPPERCROSS"),
        EventNode(id="EVT_WILLIAM_ADMIRES_ANNE_AT_LYME", fabula_time=6500, syuzhet_index=9,
                  ...
                  description="At Lyme, William Elliot — heir presumptive to Kellynch — sees and silently admires Anne, planting his later courtship.", at_location_id="LOC_LYME_REGIS"),
        EventNode(id="EVT_LOUISA_FALLS", fabula_time=7000, syuzhet_index=10,
                  ...
                  description="On the Cobb Louisa insists on jumping a second time before Wentworth is ready to catch her, falls, and is concussed; Anne directs the response while the others panic.", at_location_id="LOC_HARVILLE_LODGINGS"),
        EventNode(id="EVT_ANNE_TO_BATH", fabula_time=8000, syuzhet_index=11,
                  event_type="choice", actor_ids=["ENT_ANNE"], target_ids=[],
                  description="Anne joins Sir Walter and Elizabeth in Bath, where Lady Russell is also resident.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_WILLIAM_RETURNS_TO_FAMILY", fabula_time=8500, syuzhet_index=12,
                  ...
                  description="William Elliot reconciles with Sir Walter and Elizabeth in Bath, courting Anne under the pretext of preserving the family line.", at_location_id="LOC_LYME_REGIS"),
        EventNode(id="EVT_LOUISA_BENWICK_ENGAGED", fabula_time=9000, syuzhet_index=13,
                  ...
                  description="During Louisa's long convalescence at the Harvilles', she and Captain Benwick fall in love and become engaged, freeing Wentworth from the obligation he had felt to her.", at_location_id="LOC_HARVILLE_LODGINGS"),
        EventNode(id="EVT_ANNE_VISITS_MRS_SMITH", fabula_time=10000, syuzhet_index=14,
                  ...
                  description="Against her father's snobbish disapproval, Anne calls on her impoverished old school friend Mrs Smith in Westgate Buildings.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_MRS_SMITH_REVEALS_ELLIOT", fabula_time=10500, syuzhet_index=15,
                  ...
                  description="Mrs Smith reveals William Elliot's history of cold opportunism, his refusal to act as her husband's executor, and that his real motive in courting Anne is to forestall Mrs Clay marrying Sir Walter and bearing a displacing male heir.", at_location_id="LOC_MRS_SMITH_LODGINGS"),
        EventNode(id="EVT_WENTWORTH_TO_BATH", fabula_time=11000, syuzhet_index=16,
                  ...
                  description="Wentworth, freed by Louisa's engagement to Benwick, travels to Bath and is alarmed to find William Elliot seemingly courting Anne.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_HARVILLE_ANNE_CONVERSATION", fabula_time=11800, syuzhet_index=17,
                  ...
                  description="At the White Hart, Anne discusses with Harville the comparative constancy of men and women in love, arguing that women love longest when all hope is gone — within Wentworth's hearing.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_WENTWORTHS_LETTER", fabula_time=11900, syuzhet_index=18,
                  ...
                  description="Pierced by Anne's words, Wentworth writes the letter declaring he is half agony, half hope, and slips it where Anne will find it.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_RECONCILIATION", fabula_time=12000, syuzhet_index=19,
                  ...
                  description="In the streets of Bath, Anne and Wentworth meet, declare themselves, and renew their engagement.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_WILLIAM_LEAVES_BATH", fabula_time=13000, syuzhet_index=20,
                  ...
                  description="His scheme exposed and his hopes of Anne dashed, William Elliot quietly leaves Bath.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_MRS_CLAY_FOLLOWS_WILLIAM", fabula_time=13200, syuzhet_index=21,
                  ...
                  description="Mrs Clay slips away to become William Elliot's mistress, ending the threat that she might marry Sir Walter.", at_location_id="LOC_BATH"),
        EventNode(id="EVT_WENTWORTH_HELPS_MRS_SMITH", fabula_time=14000, syuzhet_index=22,
                  ...
                  description="After his marriage to Anne, Wentworth uses his interest to help Mrs Smith recover her West Indies property and her income.", at_location_id="LOC_BATH"),
        ...
        EventNode(id='EVT_UTT_LOUISA_TELLS_WENTWORTH', event_type='utterance',
                  ...
                  at_location_id="LOC_UPPERCROSS", content="It was Anne he asked first — she would not have him; and so he turned to Mary.",
        ...
        EventNode(id='EVT_UTT_WILLIAM_FLATTERS_ANNE', event_type='utterance',
                  ...
                  at_location_id="LOC_BATH", content="I was fascinated by the very name of Elliot — and someone, whom I shall not name, has long spoken of you with such warmth.",
        ...
        EventNode(id='EVT_UTT_MRS_SMITH_REVEALS_WILLIAM', event_type='utterance',
                  ...
                  at_location_id="LOC_MRS_SMITH_LODGINGS", content="He is a man without heart or conscience; he led my poor husband into ruin, and now courts you only to keep Mrs Clay from your father.",
        ...
        EventNode(id='EVT_UTT_ADMIRAL_CROFT_BENWICK_NEWS', event_type='utterance',
                  ...
                  at_location_id="LOC_KELLYNCH_HALL", content="Did you ever hear the like? Louisa Musgrove and James Benwick — engaged, of all things!",
        ...
        EventNode(id='EVT_UTT_ANNE_WOMEN_CONSTANCY', event_type='utterance',
                  ...
                  at_location_id="LOC_BATH", content="All the privilege I claim for my own sex — it is not a very enviable one — is that of loving longest, when existence or when hope is gone.",
        ...
        EventNode(id='EVT_UTT_WENTWORTHS_LETTER', event_type='utterance',
                  ...
                  at_location_id="LOC_BATH", content="You pierce my soul. I am half agony, half hope... I have loved none but you.",
