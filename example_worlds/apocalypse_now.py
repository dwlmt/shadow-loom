...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_SAIGON_HOTEL_BREAKDOWN", fabula_time=100, syuzhet_index=1,
                  ...
                  description="Willard, drunk and stripped to his shorts in a Saigon hotel room, smashes a mirror with his fist and weeps for a mission.", at_location_id="LOC_SAIGON_HOTEL"),
        EventNode(id="EVT_NHA_TRANG_BRIEFING", fabula_time=500, syuzhet_index=2,
                  ...
                  description="At Nha Trang two officers and a CIA man brief Willard on Colonel Kurtz, Green-Beret-gone-native in Cambodia, and order him to terminate Kurtz's command — with extreme prejudice.", at_location_id="LOC_NHA_TRANG_HQ"),
        EventNode(id="EVT_BOARD_PBR", fabula_time=1000, syuzhet_index=3,
                  ...
                  description="Willard joins the four-man crew of the Navy patrol boat that will ferry him up the Nung River to Cambodia.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_JOIN_KILGORE", fabula_time=1500, syuzhet_index=4,
                  ...
                  description="The PBR rendezvouses with the 1/9th Air Cavalry; Willard meets Kilgore, who agrees to clear a Vietcong-held river-mouth — chiefly because it has a six-foot break.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_NAPALM_SURF_RAID", fabula_time=1800, syuzhet_index=5,
                  ...
                  description="At dawn, helicopters blasting Wagner's 'Ride of the Valkyries' assault the village; F-5s drop napalm on the treeline so Lance can surf — Kilgore loves the smell of napalm in the morning.", at_location_id="LOC_KILGORE_BEACH"),
        EventNode(id="EVT_USO_CHAOS", fabula_time=2500, syuzhet_index=6,
                  ...
                  description="At the Hau Phat supply depot the crew watches a USO show; the sex-starved troops storm the stage and the Playmates are evacuated by helicopter.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_SAMPAN_MASSACRE", fabula_time=3500, syuzhet_index=7,
                  ...
                  description="Chief insists on stopping a peasant sampan; a sudden movement panics Mr Clean into firing — every civilian dies; Willard finishes the surviving woman with a single shot to keep the mission moving.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_DO_LUNG_BRIDGE", fabula_time=4500, syuzhet_index=8,
                  ...
                  description="At Do Lung Bridge — the last American outpost — there is no commanding officer; in a packet of mail Willard reads a letter revealing that Captain Colby, sent on the same mission, is now operating with Kurtz.", at_location_id="LOC_DO_LUNG_BRIDGE"),
        EventNode(id="EVT_MR_CLEAN_DEATH", fabula_time=4800, syuzhet_index=9,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_CLEAN"],
                  description="As Mr Clean listens to a tape from his mother on the family Sears stereo, a Vietcong ambush rakes the boat; he is shot dead mid-tape.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_CHIEF_SPEARED", fabula_time=5500, syuzhet_index=10,
                  ...
                  description="Primitive natives onshore loose a storm of arrows at the PBR; Chief is impaled with a thrown spear and, dying, tries to pull Willard onto the point with him.", at_location_id="LOC_PBR_RIVER"),
        EventNode(id="EVT_ARRIVE_COMPOUND", fabula_time=6000, syuzhet_index=11,
                  ...
                  description="The PBR reaches Kurtz's macabre compound — bodies, severed heads, painted Montagnards on every shore; the manic Photojournalist greets the survivors and proclaims Kurtz's genius.", at_location_id="LOC_DO_LUNG_BRIDGE"),
        EventNode(id="EVT_WILLARD_CAGED", fabula_time=6500, syuzhet_index=12,
                  ...
                  description="Kurtz's people drag Willard through the mud and lock him in a tiger cage; in the night Kurtz drops Chef's severed head into Willard's lap.", at_location_id="LOC_KURTZ_COMPOUND"),
        EventNode(id="EVT_WILLARD_READS_DOSSIER", fabula_time=7000, syuzhet_index=13,
                  ...
                  description="Freed and given the run of the compound, Willard re-reads the Kurtz dossier and listens to days of Kurtz's philosophising; his contempt curdles into recognition.", at_location_id="LOC_KURTZ_COMPOUND"),
        EventNode(id="EVT_BUFFALO_RITUAL", fabula_time=8000, syuzhet_index=14,
                  event_type="outcome", actor_ids=["ENT_WILLARD"], target_ids=["ENT_KURTZ"],
                  description="As the Montagnards ritually slaughter a garlanded caribou, Willard, mud-streaked, rises from the river and enters Kurtz's chamber with a machete.", at_location_id="LOC_KURTZ_COMPOUND"),
        EventNode(id="EVT_KURTZ_KILLED", fabula_time=8100, syuzhet_index=15,
                  event_type="outcome", actor_ids=["ENT_WILLARD"], target_ids=["ENT_KURTZ"],
                  description="Willard hacks Kurtz down with the machete, intercut with the buffalo's slaughter; Kurtz's last words are 'the horror, the horror.'", at_location_id="LOC_TEMPLE_INTERIOR"),
        EventNode(id="EVT_WILLARD_DEPARTS", fabula_time=8500, syuzhet_index=16,
                  ...
                  description="Willard drops the machete; the natives lower their weapons in obeisance; he leads Lance back to the PBR, switches off the radio that would call in the air strike, and pulls away as rain begins to fall.", at_location_id="LOC_PBR_RIVER"),
        ...
        EventNode(
            ...
            at_location_id="LOC_NHA_TRANG_HQ", content="Willard is ordered to proceed up the Nung River into Cambodia, locate Colonel Walter E. Kurtz, and terminate his command — with extreme prejudice.",
        ),
        EventNode(
        ...
        EventNode(
            ...
            at_location_id="LOC_KILGORE_BEACH", content="Kilgore orders Big Duke Six's gunships to engage the village, cue 'Ride of the Valkyries' on the loudspeakers, and call in a napalm strike on the treeline.",
        ),
        EventNode(
            ...
            at_location_id="LOC_KILGORE_BEACH", content="Kilgore tells Willard, 'I love the smell of napalm in the morning — it smells like victory,' framing the chemical incineration as sacrament.",
        ),
        EventNode(
            ...
            at_location_id="LOC_KURTZ_COMPOUND", content="The photojournalist proclaims that Kurtz is a poet-warrior who 'enlarges the mind' and warns the crew that ordinary categories cannot judge him.",
        ),
        EventNode(
            ...
            at_location_id="LOC_KURTZ_COMPOUND", content="Kurtz expounds the doctrine that horror and moral terror are friends, that one must make a friend of horror, and that the army's failure is squeamishness disguised as virtue.",
        ),
        EventNode(
            ...
            at_location_id="LOC_KURTZ_COMPOUND", content="Kurtz's dying breath is the twice-spoken phrase, 'The horror... the horror.'",
        ),
    ],
