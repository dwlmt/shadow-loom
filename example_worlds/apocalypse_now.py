...
world_state = WorldStateV1(
    ...
    entities={
        "ENT_WILLARD": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_KURTZ",
                       ...
                       proposition_id="PROP_WILLARD_TERMINATES_KURTZ"),
            ],
            concerns=[
                Concern(concern_id="CCN_WILLARD_DESIRE_TERMINATES_KURTZ", proposition_id="PROP_WILLARD_TERMINATES_KURTZ",
                        polarity="desire", kind="mission_completion", salience=0.95,
                        activation_fabula_window=(500, 8100),
                        counter_concern_ids=["CCN_WILLARD_FEAR_KURTZ_IS_SANE"]),
                Concern(concern_id="CCN_WILLARD_FEAR_KURTZ_IS_SANE", proposition_id="PROP_KURTZ_IS_SANE",
                        polarity="fear", kind="moral_unraveling", salience=0.85,
                        activation_fabula_window=(3500, 8100),
                        counter_concern_ids=["CCN_WILLARD_DESIRE_TERMINATES_KURTZ"],
                        state_timeline=[
                            ConcernSnapshot(fabula_time=7000, triggered_by="EVT_WILLARD_READS_DOSSIER",
                                            salience=0.98),
                        ]),
                Concern(concern_id="CCN_WILLARD_DESIRE_MISSION_LEGITIMATE", proposition_id="PROP_WILLARD_MISSION_LEGITIMATE",
                        polarity="desire", kind="self_justification", salience=0.85,
                        activation_fabula_window=(500, 7000),
                        state_timeline=[
                            ConcernSnapshot(fabula_time=3500, triggered_by="EVT_SAMPAN_MASSACRE",
                                            salience=0.3, kind="moral_disillusion"),
                        ]),
                Concern(concern_id="CCN_WILLARD_FEAR_RUTHLESS_KILLER", proposition_id="PROP_WILLARD_RUTHLESS_KILLER",
                        polarity="fear", kind="moral_dread", salience=0.7,
                        activation_fabula_window=(3500, 8500)),
            ],
                ...
                EntityStateSnapshot(fabula_time=4500, triggered_by="EVT_DO_LUNG_BRIDGE",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_COLBY",
                               ...
                               proposition_id="PROP_COLBY_DEFECTED"),
                    ]),
        ...
        "ENT_KURTZ": Entity(
            ...
            concerns=[
                Concern(concern_id="CCN_KURTZ_DESIRE_BE_TERMINATED", proposition_id="PROP_WILLARD_TERMINATES_KURTZ",
                        polarity="desire", kind="death_wish_release", salience=0.95,
                        activation_fabula_window=(6000, 8100),
                        state_timeline=[
                            ConcernSnapshot(fabula_time=6000, triggered_by="EVT_ARRIVE_COMPOUND",
                                            salience=1.0),
                        ]),
                Concern(concern_id="CCN_KURTZ_DESIRE_PHILOSOPHY_VINDICATED", proposition_id="PROP_KURTZ_VIEW_OF_WAR_TRUE",
                        polarity="desire", kind="philosophical_legacy", salience=0.9,
                        activation_fabula_window=(6000, 8100)),
                Concern(concern_id="CCN_KURTZ_DESIRE_HORROR_REVEALED", proposition_id="PROP_HORROR_REVEALED",
                        polarity="desire", kind="final_witness", salience=0.85,
                        activation_fabula_window=(6000, 8100)),
            ],
        ...
        "ENT_KILGORE": Entity(
            ...
            beliefs=[
                Belief(target_id="LOC_KILGORE_BEACH",
                       ...
                       proposition_id="PROP_BEACH_SURFABLE"),
            ],
            concerns=[
                Concern(concern_id="CCN_KILGORE_DESIRE_BEACH_SURFABLE", proposition_id="PROP_BEACH_SURFABLE",
                        polarity="desire", kind="surf_obsession", salience=0.95,
                        activation_fabula_window=(1500, 1800)),
                Concern(concern_id="CCN_KILGORE_DESIRE_TAKES_BEACH", proposition_id="PROP_KILGORE_TAKES_BEACH",
                        polarity="desire", kind="cavalry_assault", salience=0.95,
                        activation_fabula_window=(1500, 1800)),
            ],
        ...
        "ENT_CHIEF": Entity(
            ...
            concerns=[
                Concern(concern_id="CCN_CHIEF_DESIRE_CREW_SURVIVES", proposition_id="PROP_CREW_SURVIVES",
                        polarity="desire", kind="paternal_duty", salience=0.95,
                        activation_fabula_window=(1000, 5500)),
                Concern(concern_id="CCN_CHIEF_FEAR_WILLARD_RUTHLESS", proposition_id="PROP_WILLARD_RUTHLESS_KILLER",
                        polarity="fear", kind="loss_of_command", salience=0.85,
                        activation_fabula_window=(3500, 5500)),
                Concern(concern_id="CCN_CHIEF_DESIRE_RULES_OF_ENGAGEMENT", proposition_id="PROP_WILLARD_MISSION_LEGITIMATE",
                        polarity="desire", kind="naval_propriety", salience=0.7,
                        activation_fabula_window=(1000, 5500)),
            ],
                ...
                EntityStateSnapshot(fabula_time=3500, triggered_by="EVT_SAMPAN_MASSACRE",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_WILLARD",
                               ...
                               proposition_id="PROP_WILLARD_RUTHLESS_KILLER"),
                    ]),
        ...
        "ENT_LANCE": Entity(
            ...
            beliefs=[],
            concerns=[
                Concern(concern_id="CCN_LANCE_DESIRE_KURTZ_IS_GOD", proposition_id="PROP_KURTZ_IS_GOD",
                        polarity="desire", kind="new_belonging", salience=0.85,
                        activation_fabula_window=(6000, 8500)),
                Concern(concern_id="CCN_LANCE_FEAR_MISSION_DAMNS_CREW", proposition_id="PROP_MISSION_DAMNS_CREW",
                        polarity="fear", kind="existential_dread", salience=0.6,
                        activation_fabula_window=(3500, 6000)),
            ],
                ...
                EntityStateSnapshot(fabula_time=6000, triggered_by="EVT_ARRIVE_COMPOUND",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_KURTZ",
                               ...
                               confidence=0.9, inertia=0.85, established_at_fabula=6000, evidence_strength="strong",
                               proposition_id="PROP_KURTZ_IS_GOD"),
                    ]),
                EntityStateSnapshot(fabula_time=8500, triggered_by="EVT_WILLARD_DEPARTS",
                    location_id="LOC_PBR_RIVER"),
            ],
        ...
        "ENT_CHEF": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_WILLARD",
                       ...
                       proposition_id="PROP_MISSION_DAMNS_CREW"),
            ],
            concerns=[
                Concern(concern_id="CCN_CHEF_FEAR_MISSION_DAMNS_CREW", proposition_id="PROP_MISSION_DAMNS_CREW",
                        polarity="fear", kind="existential_dread", salience=0.95,
                        activation_fabula_window=(2800, 6500)),
                Concern(concern_id="CCN_CHEF_DESIRE_CREW_SURVIVES", proposition_id="PROP_CREW_SURVIVES",
                        polarity="desire", kind="return_home", salience=0.95,
                        activation_fabula_window=(2800, 6500)),
                Concern(concern_id="CCN_CHEF_DESIRE_AIRSTRIKE_CALLED", proposition_id="PROP_AIRSTRIKE_CALLED",
                        polarity="desire", kind="contingency_safety", salience=0.7,
                        activation_fabula_window=(6000, 6500)),
            ],
        ...
        "ENT_CLEAN": Entity(
            ...
            beliefs=[],
            concerns=[
                Concern(concern_id="CCN_CLEAN_DESIRE_CREW_SURVIVES", proposition_id="PROP_CREW_SURVIVES",
                        polarity="desire", kind="return_home", salience=0.9,
                        activation_fabula_window=(1000, 4800)),
            ],
        ...
        "ENT_PHOTOJOURNALIST": Entity(
            ...
            concerns=[
                Concern(concern_id="CCN_PHOTOJOURNALIST_DESIRE_KURTZ_IS_GOD", proposition_id="PROP_KURTZ_IS_GOD",
                        polarity="desire", kind="prophet_witness", salience=0.95,
                        activation_fabula_window=(6000, 8100)),
                Concern(concern_id="CCN_PHOTOJOURNALIST_DESIRE_KURTZ_PHILOSOPHY", proposition_id="PROP_KURTZ_VIEW_OF_WAR_TRUE",
                        polarity="desire", kind="prophet_witness", salience=0.9,
                        activation_fabula_window=(6000, 8100)),
            ],
        ...
        "ENT_COLBY": Entity(
            ...
            concerns=[
                Concern(concern_id="CCN_COLBY_DESIRE_KURTZ_IS_GOD", proposition_id="PROP_KURTZ_IS_GOD",
                        polarity="desire", kind="absolute_loyalty", salience=0.95,
                        activation_fabula_window=(4500, 8100)),
                Concern(concern_id="CCN_COLBY_FEAR_KURTZ_TERMINATED", proposition_id="PROP_WILLARD_TERMINATES_KURTZ",
                        polarity="fear", kind="defend_godhead", salience=0.85,
                        activation_fabula_window=(6000, 8100)),
            ],
        ...
        "ENT_NHA_TRANG_BRASS": Entity(
            ...
            beliefs=[],
            concerns=[
                Concern(concern_id="CCN_BRASS_DESIRE_TERMINATES_KURTZ", proposition_id="PROP_WILLARD_TERMINATES_KURTZ",
                        polarity="desire", kind="institutional_cover", salience=0.95,
                        activation_fabula_window=(500, 8100)),
                Concern(concern_id="CCN_BRASS_FEAR_KURTZ_PHILOSOPHY", proposition_id="PROP_KURTZ_VIEW_OF_WAR_TRUE",
                        polarity="fear", kind="institutional_secret", salience=0.85,
                        activation_fabula_window=(500, 8100)),
            ],
    ...
    propositions=[
        ...
        Proposition(
            proposition_id="PROP_KURTZ_IS_SANE",
            kind="trait_holds",
            referent_ids=["ENT_KURTZ"],
            description="Kurtz is in fact lucid and morally clear-eyed — the army's 'unsound methods' verdict is institutional cover for a truth they cannot tolerate.",
            audience_default_prior=0.1, stakes=0.9,
            truth_at_fabula={500: True, 7000: True, 8100: True},
        ),
        Proposition(
            proposition_id="PROP_KURTZ_IS_GOD",
            kind="trait_holds",
            referent_ids=["ENT_KURTZ", "LOC_KURTZ_COMPOUND"],
            description="Kurtz is functionally a god to the Montagnards and to the converts at his compound.",
            audience_default_prior=0.3, stakes=0.75,
            truth_at_fabula={4500: True, 6000: True, 8100: True},
        ),
        Proposition(
            proposition_id="PROP_KURTZ_VIEW_OF_WAR_TRUE",
            kind="trait_holds",
            referent_ids=["ENT_KURTZ"],
            description="Kurtz's philosophy — that the only honest response to the war is its own horror — is correct.",
            audience_default_prior=0.2, stakes=0.85,
            truth_at_fabula={3500: True, 8100: True},
        ),
        Proposition(
            proposition_id="PROP_COLBY_DEFECTED",
            kind="event_occurs",
            referent_ids=["ENT_COLBY", "ENT_KURTZ"],
            description="The army's previous assassin Colby has defected to Kurtz instead of completing his mission.",
            audience_default_prior=0.15, stakes=0.6,
            truth_at_fabula={4500: True},
        ),
        Proposition(
            proposition_id="PROP_BEACH_SURFABLE",
            kind="trait_holds",
            referent_ids=["LOC_KILGORE_BEACH"],
            description="The Vietcong-held river-mouth beach is genuinely a six-foot surf break worth taking militarily for the surf alone.",
            audience_default_prior=0.4, stakes=0.4,
            truth_at_fabula={1500: True, 1800: True},
        ),
        Proposition(
            proposition_id="PROP_KILGORE_TAKES_BEACH",
            kind="event_occurs",
            referent_ids=["EVT_NAPALM_SURF_RAID", "ENT_KILGORE", "LOC_KILGORE_BEACH"],
            description="Kilgore's air cavalry takes the river-mouth beach via the helicopter-and-napalm assault.",
            audience_default_prior=0.85, stakes=0.7,
            truth_at_fabula={1800: True},
        ),
        Proposition(
            proposition_id="PROP_WILLARD_MISSION_LEGITIMATE",
            kind="trait_holds",
            referent_ids=["ENT_WILLARD", "ENT_NHA_TRANG_BRASS"],
            description="Willard's mission is a lawful, sanctioned act under chain of command (regardless of moral content).",
            audience_default_prior=0.8, stakes=0.65,
            truth_at_fabula={500: True, 8100: True},
        ),
        Proposition(
            proposition_id="PROP_WILLARD_RUTHLESS_KILLER",
            kind="trait_holds",
            referent_ids=["ENT_WILLARD"],
            description="Willard will kill anyone — civilians, the wounded, even an unarmed survivor — to keep his mission moving.",
        ...
        Proposition(
            proposition_id="PROP_MISSION_DAMNS_CREW",
            kind="outcome",
            referent_ids=["ENT_WILLARD", "ENT_CHIEF", "ENT_CHEF", "ENT_CLEAN", "ENT_LANCE"],
            description="Willard's mission spiritually and physically damns the PBR crew — the boat should never have left the river's mouth.",
            audience_default_prior=0.55, stakes=0.9,
            truth_at_fabula={1000: False, 8500: True},
        ),
        Proposition(
            proposition_id="PROP_CREW_SURVIVES",
            kind="outcome",
            referent_ids=["ENT_CHIEF", "ENT_CHEF", "ENT_CLEAN", "ENT_LANCE"],
            description="The four-man PBR crew survives the journey to Kurtz's compound and back.",
            audience_default_prior=0.4, stakes=0.95,
            truth_at_fabula={1000: True, 8500: False},
        ),
        Proposition(
            proposition_id="PROP_PBR_REACHES_CAMP",
            kind="event_occurs",
            referent_ids=["EVT_ARRIVE_COMPOUND", "LOC_KURTZ_COMPOUND"],
            description="The patrol boat reaches Kurtz's Cambodian compound.",
            audience_default_prior=0.7, stakes=0.7,
            truth_at_fabula={6000: True},
        ),
        Proposition(
            proposition_id="PROP_AIRSTRIKE_CALLED",
            kind="event_occurs",
            referent_ids=["LOC_KURTZ_COMPOUND"],
            description="An air strike on Kurtz's compound is called in (per Willard's contingency instructions to Chef).",
            audience_default_prior=0.4, stakes=0.7,
            truth_at_fabula={6500: False, 8500: False},
        ),
        Proposition(
            proposition_id="PROP_CIVILIANS_KILLED",
            kind="event_occurs",
            referent_ids=["EVT_SAMPAN_MASSACRE", "ENT_WILLARD"],
            description="Vietnamese civilians on the sampan are killed by the PBR crew (and Willard finishes the wounded woman).",
        ...
        Proposition(
            ...
            kind="outcome",
            referent_ids=["EVT_KURTZ_KILLED", "ENT_KURTZ"],
            description="Kurtz's dying utterance — 'the horror, the horror' — reveals the war's metaphysical truth.",
            audience_default_prior=0.55, stakes=0.95,
            truth_at_fabula={8100: True},
        ),
        Proposition(
            proposition_id="PROP_WILLARD_BECOMES_KURTZ",
            kind="outcome",
            referent_ids=["ENT_WILLARD", "LOC_KURTZ_COMPOUND"],
            description="Willard accepts the Montagnards' acknowledgement of him as Kurtz's successor and remains as their new god.",
            audience_default_prior=0.15, stakes=0.85,
            truth_at_fabula={8100: False, 8500: False},
        ),
        Proposition(
            proposition_id="PROP_WILLARD_RETURNS_HOME",
            kind="outcome",
            referent_ids=["ENT_WILLARD", "EVT_WILLARD_DEPARTS"],
            description="Willard departs the compound by boat after killing Kurtz, en route home.",
            audience_default_prior=0.3, stakes=0.65,
            truth_at_fabula={8500: True},
        ),
    ],
)
