...
world_state = WorldStateV1(
    ...
    entities={
        "ENT_LAURA": Entity(
            ...
            state_timeline=[
                EntityStateSnapshot(fabula_time=100, triggered_by="EVT_GRIT_IN_EYE",
                    location_id="LOC_REFRESHMENT_ROOM"),
                EntityStateSnapshot(fabula_time=400, triggered_by="EVT_KARDOMAH_CINEMA",
                ...
                EntityStateSnapshot(fabula_time=700, triggered_by="EVT_STEPHEN_RETURNS",
                ...
                EntityStateSnapshot(fabula_time=750, triggered_by="EVT_WANDER_STREETS",
                    location_id="LOC_MILFORD_STREETS"),
                EntityStateSnapshot(fabula_time=900, triggered_by="EVT_AGREE_TO_END",
                    traits={
                        "moral_seriousness": TraitVector(value=0.95, inertia=0.9, evidence_strength="strong"),
                    }),
                EntityStateSnapshot(fabula_time=1000, triggered_by="EVT_DOLLY_INTRUDES",
                    location_id="LOC_REFRESHMENT_ROOM"),
                EntityStateSnapshot(fabula_time=1050, triggered_by="EVT_NEAR_SUICIDE",
                    location_id="LOC_PLATFORM",
                    traits={
                        "longing":  TraitVector(value=0.95, inertia=0.6, evidence_strength="strong"),
                    }),
                EntityStateSnapshot(fabula_time=1200, triggered_by="EVT_RETURN_TO_FRED",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_FRED",
                               ...
                               confidence=0.85, inertia=0.7, established_at_fabula=1200, evidence_strength="strong"),
                    ]),
            ],
        ),
        "ENT_ALEC": Entity(
                ...
                EntityStateSnapshot(fabula_time=900, triggered_by="EVT_AGREE_TO_END",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_LAURA",
                               ...
                               confidence=0.95, inertia=0.85, established_at_fabula=900, evidence_strength="strong"),
                    ]),
                EntityStateSnapshot(fabula_time=1100, triggered_by="EVT_ALEC_DEPARTS",
                    location_id=None),
            ],
        ),
        "ENT_FRED": Entity(
                ...
                EntityStateSnapshot(fabula_time=1200, triggered_by="EVT_RETURN_TO_FRED",
                    beliefs_added=[
                        Belief(target_id="ENT_LAURA",
                               ...
                               confidence=0.7, inertia=0.7, established_at_fabula=1200, evidence_strength="moderate"),
                    ]),
            ],
        ),
        "ENT_DOLLY": Entity(
        ...
        "ENT_STEPHEN": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_ALEC",
                       ...
                       confidence=0.95, inertia=0.8, established_at_fabula=700, evidence_strength="strong"),
            ],
        ),
    ...
    # ── EVENTS ──────────────────────────────────────────────────────────
    events=[
        EventNode(id="EVT_GRIT_IN_EYE", fabula_time=100, syuzhet_index=2,
        ...
        EventNode(id="EVT_CHEMIST_MEETING", fabula_time=200, syuzhet_index=3,
        ...
        EventNode(id="EVT_BOTANICAL_WALK", fabula_time=300, syuzhet_index=4,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_KARDOMAH_CINEMA", fabula_time=400, syuzhet_index=5,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_FRIENDS_SEE_THEM", fabula_time=500, syuzhet_index=6,
        ...
        EventNode(id="EVT_BORROW_FLAT_PLAN", fabula_time=600, syuzhet_index=7,
        ...
        EventNode(id="EVT_STEPHEN_RETURNS", fabula_time=700, syuzhet_index=8,
        ...
        EventNode(id="EVT_WANDER_STREETS", fabula_time=750, syuzhet_index=9,
        ...
        EventNode(id="EVT_AGREE_TO_END", fabula_time=900, syuzhet_index=10,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_DOLLY_INTRUDES", fabula_time=1000, syuzhet_index=1,
        ...
        EventNode(id="EVT_ALEC_DEPARTS", fabula_time=1020, syuzhet_index=11,
                  event_type="choice", actor_ids=["ENT_ALEC"], target_ids=["ENT_LAURA"],
        ...
        EventNode(id="EVT_NEAR_SUICIDE", fabula_time=1050, syuzhet_index=12,
        ...
        EventNode(id="EVT_RETURN_TO_FRED", fabula_time=1200, syuzhet_index=13,
        ...
        EventNode(id="EVT_STAFF_FLIRTATION_ARC", fabula_time=600, syuzhet_index=14,
    ...
    causal_topology=[
        ...
        CausalEdge(source_id="EVT_CHEMIST_MEETING", target_id="EVT_BOTANICAL_WALK",
                   ...
                   causal_force=5.0, fabula_time=200, propagation_delay=100),
        ...
        CausalEdge(source_id="EVT_KARDOMAH_CINEMA", target_id="EVT_FRIENDS_SEE_THEM",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=6.0, fabula_time=400, propagation_delay=100),
        ...
        CausalEdge(source_id="EVT_WANDER_STREETS", target_id="EVT_AGREE_TO_END",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=8.0, fabula_time=750, propagation_delay=150),
        CausalEdge(source_id="EVT_AGREE_TO_END", target_id="EVT_DOLLY_INTRUDES",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=6.0, fabula_time=900, propagation_delay=100),
        CausalEdge(source_id="EVT_DOLLY_INTRUDES", target_id="EVT_ALEC_DEPARTS",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=1000, propagation_delay=20),
        CausalEdge(source_id="EVT_ALEC_DEPARTS", target_id="EVT_NEAR_SUICIDE",
                   causality_type="chain_reaction", mechanism="emotional", evidence_strength="strong",
                   causal_force=10.0, fabula_time=1020, propagation_delay=30),
        CausalEdge(source_id="EVT_NEAR_SUICIDE", target_id="EVT_RETURN_TO_FRED",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=10.0, fabula_time=1050, propagation_delay=150),
        ...
        CausalEdge(source_id="EVT_NEAR_SUICIDE", target_id="ENT_LAURA",
                   causality_type="mutation", mechanism="emotional", evidence_strength="strong",
                   causal_force=10.0, fabula_time=1050,
        ...
        CausalEdge(source_id="EVT_DOLLY_INTRUDES", target_id="ENT_LAURA",
        ...
        CausalEdge(source_id="OBJ_STEPHENS_KEY", target_id="EVT_STEPHEN_RETURNS",
                   causality_type="affordance_gate", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=700),
        CausalEdge(source_id="OBJ_DOLLY_VOICE", target_id="EVT_DOLLY_INTRUDES",
                   causality_type="affordance_gate", mechanism="social", evidence_strength="strong",
        ...
        CausalEdge(source_id="LOC_PLATFORM", target_id="ENT_LAURA",
                   causality_type="ambient_propagation", mechanism="psychological", evidence_strength="strong",
                   causal_force=5.0, fabula_time=1050),
        ...
        CausalEdge(source_id="WORLD_DOMESTICITY", target_id="EVT_NEAR_SUICIDE",
                   ...
                   causal_force=4.0, fabula_time=1050),
        ...
        CausalEdge(source_id="WORLD_TIMETABLE", target_id="EVT_DOLLY_INTRUDES",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=6.0, fabula_time=1000),
        CausalEdge(source_id="WORLD_TIMETABLE", target_id="EVT_ALEC_DEPARTS",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=8.0, fabula_time=1020),
        ...
        CausalEdge(source_id="WORLD_INTERWAR_RESPECTABILITY", target_id="EVT_STAFF_FLIRTATION_ARC",
                   causality_type="chain_reaction", mechanism="social", evidence_strength="strong",
                   causal_force=5.0, fabula_time=600, propagation_delay=1),
    ...
    information_topology=[
        InformationEdge(source_id="ENT_LAURA", target_ids=["ENT_FRED"],
                        medium="silent_confession_in_thought", is_encrypted=True,
                        established_at_fabula=1200, terminated_at_fabula=1200,
                        discovered_at_syuzhet=13, evidence_strength="strong"),
        InformationEdge(source_id="ENT_LAURA", target_ids=["ENT_DOLLY"],
                        medium="composed_lie", is_encrypted=True,
        ...
        InformationEdge(source_id="ENT_STEPHEN", target_ids=["ENT_ALEC"],
                        medium="discreet_chastisement", is_encrypted=False,
                        established_at_fabula=700, terminated_at_fabula=700,
                        discovered_at_syuzhet=8, evidence_strength="strong"),
        InformationEdge(source_id="ENT_ALEC", target_ids=["ENT_LAURA"],
                        medium="shoulder_squeeze", is_encrypted=True,
                        established_at_fabula=1020, terminated_at_fabula=1020,
                        discovered_at_syuzhet=11, evidence_strength="strong"),
        InformationEdge(source_id="ENT_DOLLY", target_ids=["ENT_LAURA", "ENT_ALEC"],
                        medium="oblivious_chatter", is_encrypted=False,
                        established_at_fabula=1000, terminated_at_fabula=1020,
                        discovered_at_syuzhet=1, evidence_strength="strong"),
        InformationEdge(source_id="ENT_POLICEMAN", target_ids=["ENT_LAURA"],
                        medium="kindly_admonition", is_encrypted=False,
        ...
        InformationEdge(source_id="ENT_FRED", target_ids=["ENT_LAURA"],
                        medium="thanks_for_coming_back", is_encrypted=False,
                        established_at_fabula=1200, terminated_at_fabula=1200,
                        discovered_at_syuzhet=13, evidence_strength="strong"),
        InformationEdge(source_id="OBJ_TIMETABLE", target_ids=["ENT_LAURA", "ENT_ALEC"],
                        medium="public_schedule", is_encrypted=False,
                        established_at_fabula=100, terminated_at_fabula=1020,
    ...
    social_topology=[
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=0.95, inertia=0.55, evidence_strength="strong", last_updated_fabula=900),
            },
        ),
        RelationshipEdge(
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=0.7, inertia=0.7, evidence_strength="strong", last_updated_fabula=1200),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_FRED", target_entity_id="ENT_LAURA",
            metrics={
                "affinity": RelationshipMetric(value=0.85, inertia=0.75, evidence_strength="strong", last_updated_fabula=1200),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.45, inertia=0.55, evidence_strength="strong", last_updated_fabula=700),
                "power_dynamic": RelationshipMetric(value=0.5, inertia=0.7, evidence_strength="moderate", last_updated_fabula=700),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_ALEC", target_entity_id="ENT_STEPHEN",
            metrics={
                "affinity": RelationshipMetric(value=0.3, inertia=0.55, evidence_strength="moderate", last_updated_fabula=700),
                "fear":     RelationshipMetric(value=0.45, inertia=0.2, evidence_strength="moderate", last_updated_fabula=700),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity": RelationshipMetric(value=0.85, inertia=0.55, evidence_strength="strong", last_updated_fabula=600),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_MYRTLE_PALMER", target_entity_id="ENT_ALBERT_GODBY",
            metrics={
                "affinity": RelationshipMetric(value=0.7, inertia=0.55, evidence_strength="strong", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=0.5, inertia=0.7, evidence_strength="moderate", last_updated_fabula=600),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_BERYL", target_entity_id="ENT_STANLEY",
            metrics={
                "affinity": RelationshipMetric(value=0.7, inertia=0.5, evidence_strength="moderate", last_updated_fabula=600),
            },
        ),
        RelationshipEdge(
