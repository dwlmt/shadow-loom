...
world_state = WorldStateV1(
    ...
    entities={
        "ENT_LAURA": Entity(
            ...
            state_timeline=[
                ...
                EntityStateSnapshot(fabula_time=10000, triggered_by="EVT_DOLLY_INTRUDES",
                    location_id="LOC_REFRESHMENT_ROOM"),
    ...
    # ── EVENTS ──────────────────────────────────────────────────────────
    events=[
        EventNode(id="EVT_GRIT_IN_EYE", fabula_time=1000, syuzhet_index=2,
        ...
        EventNode(id="EVT_CHEMIST_MEETING", fabula_time=2000, syuzhet_index=3,
        ...
        EventNode(id="EVT_BOTANICAL_WALK", fabula_time=3000, syuzhet_index=4,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_KARDOMAH_CINEMA", fabula_time=4000, syuzhet_index=5,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_STEPHEN_RETURNS", fabula_time=7000, syuzhet_index=8,
        ...
        EventNode(id="EVT_WANDER_STREETS", fabula_time=7500, syuzhet_index=9,
        ...
        EventNode(id="EVT_AGREE_TO_END", fabula_time=9000, syuzhet_index=10,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
        ...
        EventNode(id="EVT_DOLLY_INTRUDES", fabula_time=10000, syuzhet_index=1,
        ...
        EventNode(id="EVT_ALEC_DEPARTS", fabula_time=10200, syuzhet_index=11,
                  event_type="choice", actor_ids=["ENT_ALEC"], target_ids=["ENT_LAURA"],
