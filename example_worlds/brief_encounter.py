...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_GRIT_IN_EYE", fabula_time=1000, syuzhet_index=3,
                  ...
                  description="In the refreshment room a piece of grit blows into Laura's eye and Alec, the doctor on the next stool, gently removes it — their innocent first contact.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_CHEMIST_MEETING", fabula_time=2000, syuzhet_index=4,
                  ...
                  description="The following Thursday Laura runs into Alec at Boots' the chemist; they exchange a few sentences and arrange — without saying so — to meet again.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_BOTANICAL_WALK", fabula_time=3000, syuzhet_index=5,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
                  description="They stroll together in the Botanical Gardens, ostensibly innocently, while Alec talks about his idealistic interest in industrial pneumonoconiosis.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_KARDOMAH_CINEMA", fabula_time=4000, syuzhet_index=6,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
                  description="They have lunch at the Kardomah and a matinée together; Alec admits, and Laura half-admits, that they are in love.", at_location_id="LOC_KARDOMAH"),
        EventNode(id="EVT_FRIENDS_SEE_THEM", fabula_time=5000, syuzhet_index=7,
                  ...
                  description="Coming out of the cinema they are caught by Laura's acquaintances; Laura makes the first of many small, fluent lies.", at_location_id="LOC_KARDOMAH"),
        EventNode(id="EVT_BORROW_FLAT_PLAN", fabula_time=6000, syuzhet_index=8,
                  ...
                  description="Alec arranges to borrow Stephen Lynn's flat on a Thursday evening; Laura agrees to meet him there.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_STEPHEN_RETURNS", fabula_time=7000, syuzhet_index=9,
                  ...
                  description="Stephen returns unexpectedly from his cancelled dinner; Laura escapes down the back stairs but Stephen knows what was happening and quietly chastises Alec.", at_location_id="LOC_STEPHENS_FLAT"),
        EventNode(id="EVT_WANDER_STREETS", fabula_time=7500, syuzhet_index=10,
                  event_type="choice", actor_ids=["ENT_LAURA"], target_ids=[],
                  description="Devastated, Laura wanders Milford in the rain for three hours until a constable persuades her to go home.", at_location_id="LOC_MILFORD_STREETS"),
        EventNode(id="EVT_AGREE_TO_END", fabula_time=9000, syuzhet_index=11,
                  event_type="choice", actor_ids=["ENT_LAURA", "ENT_ALEC"], target_ids=[],
                  description="At the railway station, the lovers acknowledge that they cannot make a life together; Alec resolves to take a hospital appointment in Johannesburg.", at_location_id="LOC_MILFORD_STREETS"),
        EventNode(id="EVT_FINAL_MEETING", fabula_time=10000, syuzhet_index=1,
                  ...
                  description="Their last meeting in the refreshment room is wrecked by Dolly Messiter's oblivious chatter; they cannot say what they meant to say.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_ALEC_DEPARTS", fabula_time=10200, syuzhet_index=2,
                  event_type="choice", actor_ids=["ENT_ALEC"], target_ids=["ENT_LAURA"],
                  description="Alec squeezes Laura's shoulder in lieu of a goodbye and boards his train, beginning the journey to Johannesburg.", at_location_id="LOC_REFRESHMENT_ROOM"),
        EventNode(id="EVT_NEAR_SUICIDE", fabula_time=10500, syuzhet_index=12,
                  ...
                  description="On the platform Laura nearly steps in front of the through-express; she pulls back at the last moment.", at_location_id="LOC_PLATFORM"),
        EventNode(id="EVT_RETURN_TO_FRED", fabula_time=12000, syuzhet_index=13,
                  ...
                  description="Laura returns home; Fred, sensing something without naming it, thanks her for coming back to him and she weeps in his arms.", at_location_id="LOC_LAURAS_HOME"),
        EventNode(id="EVT_STAFF_FLIRTATION_ARC", fabula_time=6000, syuzhet_index=14,
                  ...
                  description="In counterpoint, the refreshment-room staff carry on their own working-class flirtations, openly visible but checked by the rules of decorum.", at_location_id="LOC_REFRESHMENT_ROOM"),
        ...
        EventNode(id='EVT_UTT_LAURA_LIES_TO_FRIENDS', event_type='utterance',
                  ...
                  at_location_id="LOC_KARDOMAH", content="Oh — this is Dr Harvey, a friend; we ran into each other quite by chance.",
        ...
        EventNode(id='EVT_UTT_STEPHEN_CHASTISES_ALEC', event_type='utterance',
                  ...
                  at_location_id="LOC_STEPHENS_FLAT", content="I'm sorry, Alec — I had no idea you were using the flat for that sort of thing.",
        ...
        EventNode(id='EVT_UTT_POLICEMAN_URGES_HOME', event_type='utterance',
                  ...
                  at_location_id="LOC_MILFORD_STREETS", content="You all right, madam? Best be getting home now — it's late and cold.",
        ...
        EventNode(id='EVT_UTT_DOLLY_CHATTERS', event_type='utterance',
                  ...
                  at_location_id="LOC_REFRESHMENT_ROOM", content="What a lovely surprise to find you here! Now do tell me everything — I haven't seen you for ages.",
        ...
        EventNode(id='EVT_UTT_ALEC_SHOULDER_SQUEEZE', event_type='utterance',
                  ...
                  at_location_id="LOC_REFRESHMENT_ROOM", content="(a brief, deliberate squeeze of the shoulder — their entire goodbye)",
        ...
        EventNode(id='EVT_UTT_FRED_THANKS_LAURA', event_type='utterance',
                  ...
                  at_location_id="LOC_LAURAS_HOME", content="You've been a long way away. Thank you for coming back to me.",
        ...
        EventNode(id='EVT_UTT_LAURA_INTERIOR_CONFESSION', event_type='utterance',
                  ...
                  at_location_id="LOC_LAURAS_HOME", content="Fred, dear Fred — there's so much I want to tell you, you're the only one in the world with enough wisdom and gentleness to understand…",
