...
world_state = WorldStateV1(
        ...
        "ENT_NICK": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_AMY",
                       ...
                       established_at_fabula=100, evidence_strength="moderate"),
            ...
            state_timeline=[
                ...
                EntityStateSnapshot(fabula_time=600, triggered_by="EVT_NICK_AFFAIR_REVEALED",
                    traits={
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_ANDIE",
                               ...
                               established_at_fabula=600, evidence_strength="strong"),
                    ]),
                EntityStateSnapshot(fabula_time=900, triggered_by="EVT_NICK_TV_CONFESSION",
                    traits={
                ...
                EntityStateSnapshot(fabula_time=1400, triggered_by="EVT_AMY_RETURNS",
                    traits={
                        "cowardice": TraitVector(value=0.75, inertia=0.55, evidence_strength="strong"),
                    }),
                EntityStateSnapshot(fabula_time=1600, triggered_by="EVT_NICK_STAYS",
                    traits={
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_AMY",
                               ...
                               established_at_fabula=1600, evidence_strength="strong"),
                    ]),
            ],
        ),
        "ENT_AMY": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_NICK",
                       ...
                       established_at_fabula=150, evidence_strength="strong"),
                Belief(target_id="ENT_DESI",
                       ...
                       established_at_fabula=50, evidence_strength="moderate"),
            ],
            ...
            state_timeline=[
                ...
                EntityStateSnapshot(fabula_time=1000, triggered_by="EVT_AMY_ROBBED",
                ...
                EntityStateSnapshot(fabula_time=1300, triggered_by="EVT_AMY_KILLS_DESI",
                    traits={
                ...
                EntityStateSnapshot(fabula_time=600, triggered_by="EVT_NICK_AFFAIR_REVEALED",
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_NICK",
                               ...
                               established_at_fabula=600, evidence_strength="moderate"),
                    ]),
                EntityStateSnapshot(fabula_time=1400, triggered_by="EVT_AMY_RETURNS",
                    traits={
                    ...
                    beliefs_added=[
                        Belief(target_id="ENT_AMY",
                               ...
                               confidence=0.95, inertia=0.7,
                               established_at_fabula=1400, evidence_strength="strong"),
                    ]),
            ],
        ),
        "ENT_BONEY": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_NICK",
                       ...
                       established_at_fabula=300, evidence_strength="moderate"),
            ],
        ...
        "ENT_DESI": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_AMY",
                       ...
                       confidence=0.8, inertia=0.4,
                       established_at_fabula=1100, evidence_strength="moderate"),
            ],
            constants=["old_money", "obsessive_ex"],
            state_timeline=[
                EntityStateSnapshot(fabula_time=1100, triggered_by="EVT_AMY_GOES_TO_DESI",
                    location_id="LOC_DESI_LAKE_HOUSE",
                    traits={
        ...
        "ENT_TANNER": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_NICK",
                       ...
                       confidence=0.7, inertia=0.4,
                       established_at_fabula=800, evidence_strength="strong"),
            ],
        ...
        "ENT_ANDIE": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_NICK",
                       ...
                       established_at_fabula=400, evidence_strength="moderate"),
            ],
        ...
        "ENT_GILPIN": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_NICK",
                       ...
                       confidence=0.85, inertia=0.5,
                       established_at_fabula=300, evidence_strength="strong"),
            ],
    ...
    events=[
        ...
        EventNode(id="EVT_INTERROGATION", fabula_time=400, syuzhet_index=14, event_type="outcome",
                  actor_ids=["ENT_BONEY"], target_ids=["ENT_NICK"],
                  description="Detective Boney interrogates Nick, probing inconsistencies in his alibi and his flat affect."),
        EventNode(id="EVT_TREASURE_HUNT_CLUES", fabula_time=500, syuzhet_index=4, event_type="outcome",
        ...
        EventNode(id="EVT_NICK_AFFAIR_REVEALED", fabula_time=600, syuzhet_index=5, event_type="revelation",
        ...
        EventNode(id="EVT_MEDIA_TURNS", fabula_time=700, syuzhet_index=15, event_type="outcome",
        ...
        EventNode(id="EVT_NICK_HIRES_TANNER", fabula_time=800, syuzhet_index=6, event_type="choice",
        ...
        EventNode(id="EVT_NICK_TV_CONFESSION", fabula_time=900, syuzhet_index=7, event_type="choice",
        ...
        EventNode(id="EVT_AMY_ROBBED", fabula_time=1000, syuzhet_index=8, event_type="outcome",
        ...
        EventNode(id="EVT_AMY_GOES_TO_DESI", fabula_time=1100, syuzhet_index=9, event_type="choice",
    ...
    causal_topology=[
        ...
        CausalEdge(source_id="EVT_TREASURE_HUNT_CLUES", target_id="EVT_NICK_FIGURES_OUT",
                   ...
                   causal_force=8.0, fabula_time=500, propagation_delay=700),
        ...
        CausalEdge(source_id="EVT_MEDIA_TURNS", target_id="EVT_NICK_HIRES_TANNER",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=7.0, fabula_time=700, propagation_delay=100),
        ...
        CausalEdge(source_id="EVT_NICK_TV_CONFESSION", target_id="EVT_AMY_KILLS_DESI",
                   ...
                   causal_force=6.0, fabula_time=900, propagation_delay=400),
        CausalEdge(source_id="EVT_AMY_KILLS_DESI", target_id="EVT_AMY_RETURNS",
                   causality_type="chain_reaction", mechanism="physical", evidence_strength="strong",
                   causal_force=9.0, fabula_time=1300, propagation_delay=100),
        ...
        CausalEdge(source_id="EVT_AMY_PREGNANCY_TRAP", target_id="EVT_NICK_STAYS",
                   causality_type="chain_reaction", mechanism="psychological", evidence_strength="strong",
                   causal_force=9.0, fabula_time=1500, propagation_delay=100),
    ...
    information_topology=[
        InformationEdge(source_id="OBJ_DIARY", target_ids=["ENT_BONEY"],
                        medium="evidence", is_encrypted=False,
        ...
        InformationEdge(source_id="ENT_ANDIE", target_ids=["ENT_BONEY"],
                        medium="media_leak", is_encrypted=False,
        ...
        InformationEdge(source_id="ENT_TANNER", target_ids=["ENT_NICK"],
                        medium="legal_strategy", is_encrypted=True,
                        established_at_fabula=800, terminated_at_fabula=900,
                        discovered_at_syuzhet=6, evidence_strength="strong"),
        InformationEdge(source_id="ENT_AMY", target_ids=["ENT_NICK"],
                        medium="staged_return", is_encrypted=False,
                        established_at_fabula=1400, terminated_at_fabula=1400,
                        discovered_at_syuzhet=12, evidence_strength="strong"),
        InformationEdge(source_id="ENT_NOELLE", target_ids=["ENT_BONEY", "ENT_GILPIN"],
                        medium="witness_statement", is_encrypted=False,
                        established_at_fabula=500, terminated_at_fabula=500,
                        discovered_at_syuzhet=4, evidence_strength="moderate"),
        InformationEdge(source_id="ENT_NOELLE", target_ids=["ENT_NICK"],
                        medium="public_vigil_speech", is_encrypted=False,
                        established_at_fabula=600, terminated_at_fabula=600,
                        discovered_at_syuzhet=5, evidence_strength="strong"),
        InformationEdge(source_id="ENT_MARYBETH", target_ids=["ENT_NICK", "ENT_NOELLE"],
                        medium="televised_appeal", is_encrypted=False,
                        established_at_fabula=500, terminated_at_fabula=500,
                        discovered_at_syuzhet=4, evidence_strength="moderate"),
        InformationEdge(source_id="ENT_NICK", target_ids=["ENT_TANNER", "ENT_MARGO", "ENT_AMY"],
                        medium="televised_apology", is_encrypted=False,
                        established_at_fabula=900, terminated_at_fabula=900,
                        discovered_at_syuzhet=7, evidence_strength="strong"),
        InformationEdge(source_id="ENT_GILPIN", target_ids=["ENT_BONEY"],
                        medium="partner_consultation", is_encrypted=True,
                        established_at_fabula=300, evidence_strength="moderate"),
        InformationEdge(source_id="OBJ_PUPPET_STRINGS", target_ids=["ENT_NICK"],
                        medium="symbolic_clue", is_encrypted=False,
                        established_at_fabula=1200, terminated_at_fabula=1200,
                        discovered_at_syuzhet=10, evidence_strength="strong"),
        InformationEdge(source_id="ENT_AMY", target_ids=["ENT_BONEY", "ENT_GILPIN"],
                        medium="kidnapping_statement", is_encrypted=False,
                        established_at_fabula=1410, terminated_at_fabula=1410,
                        discovered_at_syuzhet=12, evidence_strength="strong"),
    ],
    ...
    world_traits={
        "WORLD_MEDIA_TRIAL": GlobalTrait(
            ...
            state_timeline=[
                WorldTraitSnapshot(fabula_time=700, triggered_by="EVT_MEDIA_TURNS",
                ...
                WorldTraitSnapshot(fabula_time=1400, triggered_by="EVT_AMY_RETURNS",
        ...
        "WORLD_SUBURBAN_PERFORMANCE": GlobalTrait(
            ...
            state_timeline=[
                WorldTraitSnapshot(fabula_time=1600, triggered_by="EVT_NICK_STAYS",
    ...
    social_topology=[
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.5, inertia=0.5, evidence_strength="strong", last_updated_fabula=1400),
                "fear":          RelationshipMetric(value=0.15, inertia=0.2, evidence_strength="moderate", last_updated_fabula=900),
                "power_dynamic": RelationshipMetric(value=0.75, inertia=0.7, evidence_strength="strong", last_updated_fabula=1500),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_NICK", target_entity_id="ENT_AMY",
            metrics={
                "affinity":      RelationshipMetric(value=-0.4, inertia=0.5, evidence_strength="strong", last_updated_fabula=900),
                "fear":          RelationshipMetric(value=0.6, inertia=0.25, evidence_strength="strong", last_updated_fabula=1400),
                "power_dynamic": RelationshipMetric(value=-0.7, inertia=0.7, evidence_strength="strong", last_updated_fabula=1500),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.9, inertia=0.55, evidence_strength="strong", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=0.0, inertia=0.6, evidence_strength="moderate", last_updated_fabula=600),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_MARGO", target_entity_id="ENT_NICK",
            metrics={
                "affinity":      RelationshipMetric(value=0.8, inertia=0.5, evidence_strength="strong", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=0.0, inertia=0.6, evidence_strength="moderate", last_updated_fabula=600),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.3, inertia=0.45, evidence_strength="strong", last_updated_fabula=1300),
                "fear":          RelationshipMetric(value=0.2, inertia=0.2, evidence_strength="moderate", last_updated_fabula=1200),
                "power_dynamic": RelationshipMetric(value=0.6, inertia=0.65, evidence_strength="strong", last_updated_fabula=1300),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_DESI", target_entity_id="ENT_AMY",
            metrics={
                "affinity":      RelationshipMetric(value=0.7, inertia=0.5, evidence_strength="strong", last_updated_fabula=1100),
                "power_dynamic": RelationshipMetric(value=-0.4, inertia=0.65, evidence_strength="strong", last_updated_fabula=1200),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.2, inertia=0.5, evidence_strength="moderate", last_updated_fabula=1400),
                "power_dynamic": RelationshipMetric(value=0.55, inertia=0.7, evidence_strength="strong", last_updated_fabula=400),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.3, inertia=0.4, evidence_strength="moderate", last_updated_fabula=600),
                "fear":          RelationshipMetric(value=0.2, inertia=0.2, evidence_strength="moderate", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=0.55, inertia=0.65, evidence_strength="strong", last_updated_fabula=400),
            },
        ),
        RelationshipEdge(
            ...
            metrics={
                ...
                "fear":          RelationshipMetric(value=0.15, inertia=0.2, evidence_strength="moderate", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=-0.55, inertia=0.65, evidence_strength="strong", last_updated_fabula=400),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.4, inertia=0.45, evidence_strength="moderate", last_updated_fabula=900),
                "power_dynamic": RelationshipMetric(value=-0.3, inertia=0.65, evidence_strength="strong", last_updated_fabula=800),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.7, inertia=0.5, evidence_strength="strong", last_updated_fabula=1400),
                "fear":          RelationshipMetric(value=0.2, inertia=0.2, evidence_strength="moderate", last_updated_fabula=1400),
                "power_dynamic": RelationshipMetric(value=-0.4, inertia=0.65, evidence_strength="strong", last_updated_fabula=1400),
            },
        ),
        RelationshipEdge(
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=-0.6, inertia=0.5, evidence_strength="strong", last_updated_fabula=400),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.5, inertia=0.5, evidence_strength="moderate", last_updated_fabula=300),
                "power_dynamic": RelationshipMetric(value=0.2, inertia=0.65, evidence_strength="moderate", last_updated_fabula=300),
            },
        ),
        # Noelle → Amy / Nick.
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.7, inertia=0.5, evidence_strength="moderate", last_updated_fabula=300),
                "power_dynamic": RelationshipMetric(value=-0.3, inertia=0.65, evidence_strength="moderate", last_updated_fabula=300),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_NOELLE", target_entity_id="ENT_NICK",
            metrics={
                "affinity":      RelationshipMetric(value=-0.75, inertia=0.5, evidence_strength="strong", last_updated_fabula=600),
                "power_dynamic": RelationshipMetric(value=0.0, inertia=0.6, evidence_strength="moderate", last_updated_fabula=600),
            },
        ),
        ...
        RelationshipEdge(
            ...
            metrics={
                "affinity":      RelationshipMetric(value=0.7, inertia=0.55, evidence_strength="strong", last_updated_fabula=200),
                "power_dynamic": RelationshipMetric(value=0.4, inertia=0.7, evidence_strength="strong", last_updated_fabula=200),
            },
        ),
        RelationshipEdge(
            source_entity_id="ENT_MARYBETH", target_entity_id="ENT_NICK",
            metrics={
                "affinity":      RelationshipMetric(value=0.2, inertia=0.5, evidence_strength="moderate", last_updated_fabula=300),
                "power_dynamic": RelationshipMetric(value=0.3, inertia=0.65, evidence_strength="moderate", last_updated_fabula=300),
            },
        ),
        RelationshipEdge(
