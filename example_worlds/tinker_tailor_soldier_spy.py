...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_PRIDEAUX_HUNGARY_MISSION", fabula_time=500, syuzhet_index=1,
                  ...
                  description="Control sends Prideaux to Hungary to meet a Hungarian general who promised to sell the mole's identity.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_PRIDEAUX_SHOT", fabula_time=1000, syuzhet_index=2,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_JIM_PRIDEAUX"],
                  description="Prideaux is shot by Soviet agents in Budapest.", at_location_id="LOC_HUNGARY"),
        EventNode(id="EVT_PRIDEAUX_CAPTURED", fabula_time=1500, syuzhet_index=4,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_JIM_PRIDEAUX"],
                  description="Soviet agents capture the wounded Prideaux.", at_location_id="LOC_HUNGARY"),
        EventNode(id="EVT_PRIDEAUX_KILLED_FALSE", fabula_time=2000, syuzhet_index=5,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_JIM_PRIDEAUX"],
                  description="The Circus receives reports that Prideaux was killed in Hungary. (Later revealed to be false.)", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_CONTROL_FORCED_RETIREMENT", fabula_time=2500, syuzhet_index=6,
                  ...
                  description="Control and Smiley are forced into retirement after the Hungary disaster.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_ALLELINE_BECOMES_CHIEF", fabula_time=3000, syuzhet_index=7,
                  ...
                  description="Percy Alleline becomes the new Chief of the Circus, with Haydon as his deputy.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_WITCHCRAFT_PROJECT_STARTS", fabula_time=3200, syuzhet_index=8,
                  ...
                  description="The Witchcraft project begins producing high-grade Soviet intelligence shared with the Americans.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_SACHS_SACKED", fabula_time=3500, syuzhet_index=9,
                  ...
                  description="Connie Sachs is sacked by Alleline after claiming Polyakov is a Soviet mole handler.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_CONTROL_DIES", fabula_time=4000, syuzhet_index=10,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_CONTROL"],
                  description="Control dies, already ill from the forced retirement.", at_location_id="LOC_ENGLAND_EXILE"),
        EventNode(id="EVT_LACON_RECRUITS_SMILEY", fabula_time=5000, syuzhet_index=11,
                  ...
                  description="Lacon brings Smiley out of retirement to investigate Tarr's claim of a mole.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_TARR_ISTANBUL_MISSION", fabula_time=7000, syuzhet_index=12,
                  ...
                  description="Tarr is sent to Istanbul to investigate Soviet agent Boris.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_TARR_MEETS_IRINA", fabula_time=7500, syuzhet_index=13,
                  ...
                  description="Tarr meets Boris's wife Irina and begins an affair with her.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_IRINA_DEFECTION_REQUEST", fabula_time=8000, syuzhet_index=14,
                  ...
                  description="Irina tells Tarr she wants to defect and reveals there is a mole at the Circus sent by Karla.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_TARR_SENDS_REQUEST", fabula_time=8500, syuzhet_index=16,
                  event_type="choice", actor_ids=["ENT_RICKI_TARR"], target_ids=[],
                  description="Tarr sends Irina's defection request back to London.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_BORIS_MURDERED", fabula_time=9000, syuzhet_index=17,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_BORIS"],
                  description="Boris is suddenly killed in Istanbul.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_IRINA_CAPTURED", fabula_time=10000, syuzhet_index=18,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_IRINA"],
                  description="Irina is captured by Soviet agents and taken back to Russia.", at_location_id="LOC_ISTANBUL"),
        EventNode(id="EVT_TARR_FLEES", fabula_time=11000, syuzhet_index=19,
                  event_type="choice", actor_ids=["ENT_RICKI_TARR"], target_ids=[],
                  description="Tarr goes on the run after being accused of defecting and murdering the British station chief.", at_location_id="LOC_SMILEY_HOUSE"),
        EventNode(id="EVT_SMILEY_INTERVIEWS_SACHS", fabula_time=12000, syuzhet_index=20,
                  ...
                  description="Smiley interviews Connie Sachs, who tells him about Polyakov being a mole handler.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_SMILEY_INTERVIEWS_WESTERBY", fabula_time=13000, syuzhet_index=22,
                  ...
                  description="Smiley interviews Jerry Westerby, the duty clerk on the night Prideaux was shot.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_WESTERBY_REVEALS_AFFAIR", fabula_time=13000, syuzhet_index=23,
                  ...
                  description="Westerby reveals that Ann answered when he called Smiley's house that night, and Haydon arrived shortly after — implying Haydon was with Ann.", at_location_id="LOC_ENGLAND_EXILE"),
        EventNode(id="EVT_TARR_VISITS_SMILEY", fabula_time=13500, syuzhet_index=24,
                  ...
                  description="Tarr visits Smiley at his home and tells him the full Istanbul story.", at_location_id="LOC_SMILEY_HOUSE"),
        EventNode(id="EVT_GUILLAM_STEALS_LOGBOOK", fabula_time=14000, syuzhet_index=25,
                  ...
                  description="Guillam steals the Circus duty logbook for the night Tarr called.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_LOGBOOK_PAGES_CUT", fabula_time=14500, syuzhet_index=26,
                  ...
                  description="Smiley discovers the logbook pages for that night have been cut out — confirming Tarr's story.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_SMILEY_FINDS_PRIDEAUX", fabula_time=16000, syuzhet_index=27,
                  ...
                  description="Smiley locates Prideaux alive in England — the 'killed in Hungary' report was false.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_PRIDEAUX_INTERVIEWED", fabula_time=16500, syuzhet_index=28,
                  ...
                  description="Smiley interviews Prideaux, who reveals Control's Tinker/Tailor/Soldier/Poorman/Beggarman codenames for the suspects.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_PRIDEAUX_SEES_IRINA_SHOT", fabula_time=17000, syuzhet_index=30,
                  ...
                  description="Prideaux tells Smiley he saw a blonde female prisoner (Irina) shot during his interrogation.", at_location_id="LOC_ENGLAND_EXILE"),
        EventNode(id="EVT_TINKER_TAILOR_REVEALED", fabula_time=17500, syuzhet_index=31,
                  ...
                  description="The codenames are revealed: Tinker (Alleline), Tailor (Haydon), Soldier (Bland), Poorman (Esterhase), Beggarman (Smiley).", at_location_id="LOC_ENGLAND_EXILE"),
        EventNode(id="EVT_SAFE_HOUSE_MEETINGS_DISCOVERED", fabula_time=18000, syuzhet_index=32,
                  event_type="revelation", actor_ids=["ENT_GEORGE_SMILEY"], target_ids=[],
                  description="Smiley learns that Alleline, Haydon, Bland, and Esterhase meet Polyakov regularly at a safe house.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_ESTERHASE_PRESSED", fabula_time=19000, syuzhet_index=33,
                  ...
                  description="Smiley threatens to deport Esterhase (a wanted criminal in Hungary) to get the safe house location.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_SAFE_HOUSE_LOCATION_REVEALED", fabula_time=19500, syuzhet_index=34,
                  ...
                  description="Esterhase reveals the safe house is in Lock Gardens.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_TARR_TRAP_PARIS", fabula_time=20000, syuzhet_index=35,
                  event_type="choice", actor_ids=["ENT_RICKI_TARR"], target_ids=[],
                  description="Tarr appears at the Paris office announcing he knows who the mole is and is ready to give the name.", at_location_id="LOC_PARIS_OFFICE"),
        EventNode(id="EVT_MOLE_PANICS", fabula_time=21000, syuzhet_index=37,
                  event_type="outcome", actor_ids=["ENT_BILL_HAYDON"], target_ids=[],
                  description="The mole (Haydon) hears about Tarr and arranges an emergency meeting with Polyakov at the safe house.", at_location_id="LOC_THE_CIRCUS"),
        EventNode(id="EVT_SAFE_HOUSE_AMBUSH", fabula_time=21500, syuzhet_index=38,
                  ...
                  description="Smiley waits at the safe house to catch the mole, the safe-house ledger of past meetings spread before him alongside Tarr's defection file — the cross-referenced bait that drew Haydon in.", at_location_id="LOC_LACON_HOUSE"),
        EventNode(id="EVT_HAYDON_UNMASKED", fabula_time=22000, syuzhet_index=39,
                  event_type="revelation", actor_ids=["ENT_GEORGE_SMILEY"], target_ids=[],
                  description="Haydon arrives at the safe house and is captured by Smiley — the mole is unmasked.", at_location_id="LOC_SAFE_HOUSE"),
        EventNode(id="EVT_HAYDON_CONFESSION", fabula_time=23000, syuzhet_index=40,
                  ...
                  description="At Sarratt, Haydon confesses he seduced Ann on Karla's orders and that Prideaux confided in him before the Hungary mission.", at_location_id="LOC_SARRATT"),
        EventNode(id="EVT_PRIDEAUX_KILLS_HAYDON", fabula_time=24000, syuzhet_index=42,
                  ...
                  description="Prideaux, learning of Haydon's betrayal, kills Haydon at Sarratt with Haydon's own service revolver — a final symbolic inversion.", at_location_id="LOC_SARRATT"),
        EventNode(id="EVT_SMILEY_RESTORED_CHIEF", fabula_time=25000, syuzhet_index=43,
                  ...
                  description="Smiley is restored as Chief of the Circus.", at_location_id="LOC_THE_CIRCUS"),
        ...
        EventNode(id="EVT_UTT_IRINA_MOLE_CLAIM", event_type="utterance",
                  ...
                  at_location_id="LOC_ISTANBUL", speaker_id="ENT_IRINA", addressee_ids=["ENT_RICKI_TARR"],
        ...
        EventNode(id="EVT_UTT_WESTERBY_DUTY_CALL", event_type="utterance",
                  ...
                  at_location_id="LOC_THE_CIRCUS", speaker_id="ENT_JERRY_WESTERBY", addressee_ids=["ENT_ANN_SMILEY"],
        ...
        EventNode(id="EVT_UTT_SACHS_POLYAKOV_WARNING", event_type="utterance",
                  ...
                  at_location_id="LOC_ENGLAND_EXILE", speaker_id="ENT_CONNIE_SACHS", addressee_ids=["ENT_GEORGE_SMILEY"],
        ...
        EventNode(id="EVT_UTT_PRIDEAUX_CONFESSION", event_type="utterance",
                  ...
                  at_location_id="LOC_ENGLAND_EXILE", speaker_id="ENT_JIM_PRIDEAUX", addressee_ids=["ENT_GEORGE_SMILEY"],
        ...
        EventNode(id="EVT_UTT_HAYDON_CONFESSION_ANN", event_type="utterance",
                  ...
                  at_location_id="LOC_SARRATT", speaker_id="ENT_BILL_HAYDON", addressee_ids=["ENT_GEORGE_SMILEY"],
        ...
        EventNode(id="EVT_UTT_TARR_PARIS_ANNOUNCEMENT", event_type="utterance",
                  ...
                  at_location_id="LOC_PARIS_OFFICE", speaker_id="ENT_RICKI_TARR", addressee_ids=["ENT_BILL_HAYDON"],
