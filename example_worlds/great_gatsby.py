...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_GATSBY_MEETS_DAISY_1917", fabula_time=500, syuzhet_index=16,
                  ...
                  description="In Louisville, 1917, Lieutenant Gatsby and the debutante Daisy fall in love before he ships out for the war.", at_location_id="LOC_GATSBYS_MANSION"),
        EventNode(id="EVT_DAISY_MARRIES_TOM", fabula_time=800, syuzhet_index=18,
                  ...
                  description="With Gatsby still overseas, Daisy reluctantly marries Tom Buchanan, the wealthy Yale football star from Chicago.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_NICK_MOVES_EAST", fabula_time=1000, syuzhet_index=1,
                  event_type="choice", actor_ids=["ENT_NICK"], target_ids=[],
                  description="In spring 1922 Nick Carraway moves east to sell bonds and rents a bungalow in West Egg next to Gatsby's mansion.", at_location_id="LOC_WEST_EGG"),
        EventNode(id="EVT_NICK_DINES_AT_BUCHANANS", fabula_time=2000, syuzhet_index=2,
                  ...
                  description="Nick dines in East Egg with the Buchanans and meets Jordan Baker, who reveals that Tom keeps a mistress.", at_location_id="LOC_WEST_EGG"),
        EventNode(id="EVT_NICK_SEES_GREEN_LIGHT", fabula_time=2500, syuzhet_index=4,
                  ...
                  description="Returning home, Nick sees Gatsby alone on his lawn, stretching his arms toward a green light across the bay.", at_location_id="LOC_WEST_EGG"),
        EventNode(id="EVT_TOM_TAKES_NICK_TO_NY", fabula_time=3500, syuzhet_index=5,
                  ...
                  description="Tom drags Nick into the city by way of Wilson's garage, picking up Myrtle for a party at his Manhattan apartment.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_TOM_BREAKS_NOSE", fabula_time=5000, syuzhet_index=6,
                  ...
                  description="At the apartment party Tom slaps Myrtle and breaks her nose for daring to mention Daisy's name.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_NICK_AT_GATSBYS_PARTY", fabula_time=7000, syuzhet_index=8,
                  ...
                  description="Nick attends one of Gatsby's vast Saturday-night parties; Gatsby singles him out and introduces himself.", at_location_id="LOC_WEST_EGG"),
        EventNode(id="EVT_JORDAN_TELLS_NICK_HISTORY", fabula_time=8000, syuzhet_index=10,
                  ...
                  description="At the Plaza, Jordan tells Nick that Gatsby and Daisy were lovers in 1917 and that the parties have all been bait to draw Daisy back.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_GATSBY_DAISY_REUNION", fabula_time=9000, syuzhet_index=12,
                  ...
                  description="Nick stages a tea-time reunion at his bungalow; Gatsby and Daisy embark on an affair.", at_location_id="LOC_GATSBYS_MANSION"),
        EventNode(id="EVT_TOM_DISCOVERS_AFFAIR", fabula_time=12000, syuzhet_index=13,
                  ...
                  description="Daisy carelessly addresses Gatsby with unmistakable intimacy in front of Tom, who realises the affair.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_GEORGE_SUSPECTS_AFFAIR", fabula_time=12800, syuzhet_index=20,
                  ...
                  description="George finds evidence that Myrtle has a lover, locks her upstairs, and resolves to take her west.", at_location_id="LOC_WILSON_GARAGE"),
        EventNode(id="EVT_PLAZA_CONFRONTATION", fabula_time=13000, syuzhet_index=21,
                  ...
                  description="In a Plaza Hotel suite Gatsby demands Daisy say she never loved Tom; Tom exposes Gatsby's bootlegging; Daisy retreats to Tom.", at_location_id="LOC_GATSBYS_MANSION"),
        EventNode(id="EVT_MYRTLE_KILLED", fabula_time=14500, syuzhet_index=22,
                  ...
                  description="Driving Gatsby's yellow car back to East Egg, Daisy strikes and kills Myrtle, who has run into the road; Gatsby resolves to take the blame.", at_location_id="LOC_EAST_EGG"),
        EventNode(id="EVT_TOM_TELLS_GEORGE", fabula_time=14800, syuzhet_index=23,
                  ...
                  description="Tom tells the grieving George that Gatsby owns the yellow car, knowing George will assume Gatsby was Myrtle's lover and killer.", at_location_id="LOC_WILSON_GARAGE"),
        EventNode(id="EVT_GATSBY_KILLED", fabula_time=15000, syuzhet_index=24,
                  ...
                  description="George shoots Gatsby in his swimming pool and then kills himself.", at_location_id="LOC_GATSBYS_MANSION"),
        EventNode(id="EVT_FUNERAL", fabula_time=16000, syuzhet_index=25,
                  ...
                  description="Almost no one attends Gatsby's funeral; only Nick and the late-arriving Henry Gatz mourn him.", at_location_id="LOC_WEST_EGG"),
        EventNode(id="EVT_NICK_RETURNS_WEST", fabula_time=17000, syuzhet_index=26,
                  event_type="choice", actor_ids=["ENT_NICK"], target_ids=[],
                  description="Disgusted with the East, Nick decides to return to the Midwest; he encounters Tom on Fifth Avenue and reluctantly shakes his hand.", at_location_id="LOC_MIDWEST"),
        ...
        EventNode(id='EVT_UTT_JORDAN_REVEALS_MISTRESS', event_type='utterance',
                  ...
                  at_location_id="LOC_EAST_EGG", content="Tom's got some woman in New York — she lives down in the valley of ashes and has the gall to call him up at dinner-time.",
        ...
        EventNode(id='EVT_UTT_GATSBY_WAR_TALES', event_type='utterance',
                  ...
                  at_location_id="LOC_GATSBYS_MANSION", content="I lived like a young rajah in all the capitals of Europe — and yes, I was at Oxford; in the war I was promoted to Major and every Allied government decorated me.",
        ...
        EventNode(id='EVT_UTT_JORDAN_REVEALS_HISTORY', event_type='utterance',
                  ...
                  at_location_id="LOC_NEW_YORK_APT", content="Gatsby and Daisy were lovers in Louisville back in 1917 before he shipped out — and the parties have all been bait to bring her over from East Egg.",
                  speaker_id='ENT_JORDAN', addressee_ids=['ENT_NICK'], actor_ids=['ENT_JORDAN'],
        ...
        EventNode(id='EVT_UTT_DAISY_INTIMATE_ADDRESS', event_type='utterance',
                  ...
                  at_location_id="LOC_EAST_EGG", content="Ah, you look so cool — you always look so cool; you resemble the advertisement of the man.",
        ...
        EventNode(id='EVT_UTT_GATSBY_DEMANDS_DENIAL', event_type='utterance',
                  ...
                  at_location_id="LOC_GATSBYS_MANSION", content="Just tell him the truth — that you never loved him — and it's all wiped out forever.",
        ...
        EventNode(id='EVT_UTT_TOM_EXPOSES_BOOTLEG', event_type='utterance',
                  ...
                  at_location_id="LOC_EAST_EGG", content="He and this Wolfshiem bought up a lot of side-street drug-stores and sold grain alcohol over the counter — that's just one of his little stunts.",
        ...
        EventNode(id='EVT_UTT_GATSBY_CONFESSES_BLAME', event_type='utterance',
                  ...
                  at_location_id="LOC_GATSBYS_MANSION", content="Of course I'll say I was driving. Daisy was at the wheel — but I'll take the blame for it.",
                  speaker_id='ENT_GATSBY', addressee_ids=['ENT_NICK'], actor_ids=['ENT_GATSBY'],
        ...
        EventNode(id='EVT_UTT_TOM_DIRECTS_GEORGE', event_type='utterance',
                  ...
                  at_location_id="LOC_WILSON_GARAGE", content="That yellow car I drove down this afternoon wasn't mine — do you hear me? It was Gatsby's car.",
    ...
    propositions=[
        ...
        Proposition(proposition_id="PROP_GATSBY_REDEEMED", kind="trait_holds",
                    referent_ids=["ENT_GATSBY"],
                    description="Gatsby's romantic readiness is morally redeemed (post-funeral, in Nick's retrospective narration).",
                    audience_default_prior=0.4, stakes=0.7,
