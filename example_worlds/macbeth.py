...
world_state = WorldStateV1(
    ...
    entities={
        ...
        "ENT_BANQUO": Entity(
            ...
            beliefs=[
                ...
                Belief(target_id="ENT_MACBETH", perceived_state="Macbeth may have played foully for the crown", confidence=0.6, inertia=0.3, established_at_fabula=1000),
            ],
            state_timeline=[
        ...
        "ENT_MACDUFF": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_MACBETH", perceived_state="Macbeth is a tyrant who murdered Duncan", confidence=0.7, inertia=0.4, established_at_fabula=800),
            ],
        ...
        "ENT_MALCOLM": Entity(
            ...
            beliefs=[
                Belief(target_id="ENT_MACBETH", perceived_state="Macbeth may have killed my father", confidence=0.6, inertia=0.4, established_at_fabula=800),
            ],
            state_timeline=[
                EntityStateSnapshot(fabula_time=900, triggered_by="EVT_SONS_FLEE", location_id="LOC_ENGLAND"),
            ],
        ),
        "ENT_WITCHES": Entity(
    ...
    events=[
        ...
        EventNode(id="EVT_SERVANTS_FRAMED", fabula_time=700, syuzhet_index=7,
        ...
        EventNode(id="EVT_MACBETH_KILLS_SERVANTS", fabula_time=800, syuzhet_index=8,
        ...
        EventNode(id="EVT_SONS_FLEE", fabula_time=900, syuzhet_index=9,
                  event_type="choice", actor_ids=["ENT_MALCOLM"], target_ids=[],
                  description="Duncan's sons flee Scotland, fearing for their lives."),
        EventNode(id="EVT_MACBETH_CROWNED", fabula_time=1000, syuzhet_index=10,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_MACBETH"],
        ...
        EventNode(id="EVT_BANQUO_GHOST", fabula_time=1200, syuzhet_index=12,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_MACBETH"],
