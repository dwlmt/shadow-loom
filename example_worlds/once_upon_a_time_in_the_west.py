...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_FLASHBACK_HANGING", fabula_time=0, syuzhet_index=18,
                  ...
                  description="Years before, Frank prepared to hang a man by making the man's younger brother support him on his shoulders, a harmonica forced into the boy's mouth; eventually the boy collapses, dooming his brother.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_MORTON_HIRES_FRANK", fabula_time=500, syuzhet_index=8,
                  ...
                  description="Morton, dying of spinal tuberculosis and obsessed with seeing his railroad reach the Pacific, hires Frank to intimidate — not murder — Brett McBain off Sweetwater.", at_location_id="LOC_MORTONS_TRAIN"),
        EventNode(id="EVT_MCBAIN_FAMILY_MURDER", fabula_time=1000, syuzhet_index=2,
                  ...
                  description="Frank and his gang massacre Brett McBain and his three children at Sweetwater as they prepare for a celebration — exceeding Morton's brief.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_HARMONICA_ARRIVES", fabula_time=1100, syuzhet_index=1,
                  ...
                  description="A train arrives at Flagstone; the man with a harmonica steps off and kills three of Frank's men sent to ambush him, then waits.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_JILL_ARRIVES_AT_SWEETWATER", fabula_time=1200, syuzhet_index=3,
                  ...
                  description="Jill McBain — a former New Orleans prostitute, married to Brett a month earlier — arrives at Sweetwater to find her new family murdered.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_FRANK_FRAMES_CHEYENNE", fabula_time=1300, syuzhet_index=4,
                  ...
                  description="Frank plants evidence at the murder scene implicating the outlaw Cheyenne.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_HARMONICA_MEETS_CHEYENNE", fabula_time=1500, syuzhet_index=5,
                  ...
                  description="Harmonica encounters Cheyenne, now a fugitive; Cheyenne denies sending the ambushers and the two begin a wary alliance.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_HARMONICA_SAVES_JILL", fabula_time=1700, syuzhet_index=6,
                  ...
                  description="Harmonica kills two of Frank's men sent to murder Jill at Sweetwater.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_HARMONICA_SPIES_MORTON_TRAIN", fabula_time=2000, syuzhet_index=7,
                  ...
                  description="Harmonica spies out Morton's private railway carriage and discovers the connection between Frank and the dying tycoon — but is captured.", at_location_id="LOC_MORTONS_TRAIN"),
        EventNode(id="EVT_HARMONICA_CAPTURED", fabula_time=2100, syuzhet_index=9,
                  ...
                  description="Frank's men capture Harmonica; Frank is called away before he can deal with him personally.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_CHEYENNE_RESCUES_HARMONICA", fabula_time=2200, syuzhet_index=10,
                  ...
                  description="Cheyenne rescues Harmonica; the two formally agree to help Jill keep Sweetwater, using stockpiled materials to start building the water station.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_FRANK_FORCES_JILL", fabula_time=2500, syuzhet_index=11,
                  ...
                  description="Frank corners Jill in a sexually threatening encounter and forces her to put Sweetwater up for auction.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_AUCTION", fabula_time=2700, syuzhet_index=12,
                  ...
                  description="Frank's henchmen intimidate bidders so Frank can buy Sweetwater cheap; Harmonica appears with Cheyenne in tow and bids the $5,000 bounty on Cheyenne's head.", at_location_id="LOC_MORTONS_TRAIN"),
        EventNode(id="EVT_MORTON_BRIBES_FRANKS_MEN", fabula_time=2900, syuzhet_index=13,
                  ...
                  description="Morton, fearing Frank now wants Sweetwater for himself, bribes Frank's own men to kill him.", at_location_id="LOC_MORTONS_TRAIN"),
        EventNode(id="EVT_HARMONICA_SAVES_FRANK", fabula_time=2950, syuzhet_index=14,
                  ...
                  description="Harmonica intervenes to save Frank from the bribed henchmen — the debt between them must be settled in person.", at_location_id="LOC_MORTONS_TRAIN"),
        EventNode(id="EVT_TRAIN_GUNFIGHT", fabula_time=3100, syuzhet_index=15,
                  ...
                  description="Cheyenne's gang engages Frank's remaining men on Morton's train; everyone dies, including Morton, who crawls toward a muddy puddle in his last seconds.", at_location_id="LOC_FLAGSTONE_STATION"),
        EventNode(id="EVT_FRANK_RIDES_TO_SWEETWATER", fabula_time=3200, syuzhet_index=16,
                  ...
                  description="Surveying the aftermath, Frank rides to Sweetwater, where Harmonica is waiting.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_SHOWDOWN_FLASHBACK_REVEAL", fabula_time=3300, syuzhet_index=17,
                  ...
                  description="In the showdown a flashback finally reveals Harmonica's identity; Harmonica beats Frank to the draw and pushes the harmonica into the dying man's mouth.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_FRANK_DIES", fabula_time=3350, syuzhet_index=19,
                  ...
                  description="Frank dies in the dust outside Sweetwater, the harmonica between his teeth.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_BUILDING_STATION_AT_SWEETWATER", fabula_time=3400, syuzhet_index=20,
                  ...
                  description="With Frank dead and Cheyenne riding off mortally wounded, Jill begins building the water station for the approaching railroad workers — the new Old West takes shape over the bones of the old.", at_location_id="LOC_SWEETWATER"),
        EventNode(id="EVT_CHEYENNE_RIDES_OFF_DYING", fabula_time=3400, syuzhet_index=21,
                  ...
                  description="Cheyenne, mortally wounded in the train gunfight, rides off into the desert to die alone rather than in front of Jill.", at_location_id="LOC_FLAGSTONE_STATION"),
        ...
        EventNode(id="EVT_UTT_MORTON_COMMISSIONS_FRANK", event_type="utterance",
                  ...
                  at_location_id="LOC_MORTONS_TRAIN", content="Frighten McBain off Sweetwater — but don't kill him. I want the land cleared, not a vendetta.",
        ...
        EventNode(id="EVT_UTT_FRANK_NAMES_CHEYENNE", event_type="utterance",
                  ...
                  at_location_id="LOC_SWEETWATER", content="That looked like Cheyenne's work — those long dusters, that mark on the brand.",
        ...
        EventNode(id="EVT_UTT_CHEYENNE_DENIES_AMBUSH", event_type="utterance",
                  ...
                  at_location_id="LOC_FLAGSTONE_STATION", content="Those weren't my men. I don't kill strangers for money — I kill them for reasons.",
        ...
        EventNode(id="EVT_UTT_FRANK_DEMANDS_NAME", event_type="utterance",
                  ...
                  at_location_id="LOC_SWEETWATER", content="Who are you?",
        ...
        EventNode(id="EVT_UTT_HARMONICA_PLAYS_THEME", event_type="utterance",
                  ...
                  at_location_id="LOC_SWEETWATER", content="(plays the harmonica theme — the same notes the boy was forced to play under the desert arch)",
        ...
        EventNode(id="EVT_UTT_AUCTION_CALL", event_type="utterance",
                  ...
                  at_location_id="LOC_MORTONS_TRAIN", content="Five thousand dollars. The bounty on this man's head — payable to the United States Marshal's account, here and now.",
