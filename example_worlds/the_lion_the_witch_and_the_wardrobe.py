...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_PEVENSIES_ARRIVE", fabula_time=1000, syuzhet_index=1,
                  ...
                  description="The four Pevensie children arrive at Professor Kirke's country house during the war.", at_location_id="LOC_PROFESSOR_HOUSE"),
        EventNode(id="EVT_LUCY_ENTERS_NARNIA", fabula_time=2000, syuzhet_index=2,
                  event_type="choice", actor_ids=["ENT_LUCY"], target_ids=[],
                  description="Lucy discovers the wardrobe and steps through into Narnia for the first time.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_LUCY_MEETS_TUMNUS", fabula_time=2500, syuzhet_index=3,
                  ...
                  description="Lucy encounters Mr. Tumnus the Faun at the lamppost in the snowy woods.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_TUMNUS_SPARES_LUCY", fabula_time=3000, syuzhet_index=5,
                  ...
                  description="Tumnus confesses he was supposed to capture Lucy for the Witch, but chooses to let her go free.", at_location_id="LOC_TUMNUS_CAVE"),
        EventNode(id="EVT_EDMUND_ENTERS_NARNIA", fabula_time=3500, syuzhet_index=6,
                  event_type="choice", actor_ids=["ENT_EDMUND"], target_ids=[],
                  description="Edmund follows Lucy into the wardrobe and enters Narnia alone.", at_location_id="LOC_PROFESSOR_HOUSE"),
        EventNode(id="EVT_EDMUND_TURKISH_DELIGHT", fabula_time=4000, syuzhet_index=7,
                  ...
                  description="The White Witch feeds Edmund enchanted Turkish Delight, creating an insatiable craving.", at_location_id="LOC_WITCH_CASTLE"),
        EventNode(id="EVT_EDMUND_DENIES_NARNIA", fabula_time=5000, syuzhet_index=9,
                  ...
                  description="Edmund spitefully denies Narnia's existence to Peter and Susan, betraying Lucy's trust.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_PROFESSOR_DEFENDS_LUCY", fabula_time=5500, syuzhet_index=10,
                  ...
                  description="Professor Kirke argues logically that Lucy is likely telling the truth about Narnia.", at_location_id="LOC_PROFESSOR_HOUSE"),
        EventNode(id="EVT_ALL_ENTER_NARNIA", fabula_time=6000, syuzhet_index=11,
                  event_type="outcome", actor_ids=["ENT_LUCY", "ENT_EDMUND", "ENT_PETER", "ENT_SUSAN"], target_ids=[],
                  description="All four children hide in the wardrobe and find themselves together in Narnia.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_TUMNUS_ARRESTED", fabula_time=7500, syuzhet_index=12,
                  ...
                  description="The children discover Tumnus has been arrested for treason; his cave ransacked.", at_location_id="LOC_WITCH_CASTLE"),
        EventNode(id="EVT_MEET_BEAVERS", fabula_time=8000, syuzhet_index=13,
                  ...
                  description="Guided by a robin, the children meet Mr. Beaver, who offers to help them.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_BEAVERS_EXPLAIN_ASLAN", fabula_time=9000, syuzhet_index=15,
                  ...
                  description="At the Beavers' dam, Mr. Beaver explains Aslan's return and the prophecy of four thrones.", at_location_id="LOC_BEAVERS_DAM"),
        EventNode(id="EVT_EDMUND_BETRAYS", fabula_time=10000, syuzhet_index=16,
                  ...
                  description="Edmund slips away from the Beavers' dam to warn the White Witch about Aslan.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_JOURNEY_TO_STONE_TABLE", fabula_time=11000, syuzhet_index=18,
                  ...
                  description="The remaining children and Beavers flee through the melting snow toward the Stone Table.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_FATHER_CHRISTMAS_GIFTS", fabula_time=11500, syuzhet_index=19,
                  ...
                  description="Father Christmas appears and gives magical gifts: Peter's sword, Susan's horn and bow, Lucy's cordial.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_SPRING_THAW", fabula_time=12000, syuzhet_index=20,
                  event_type="outcome", actor_ids=[], target_ids=[],
                  description="The enchanted winter breaks; snow melts and spring returns to Narnia.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_MEET_ASLAN", fabula_time=12500, syuzhet_index=21,
                  ...
                  description="The three children reach Aslan's camp and meet the Great Lion for the first time.", at_location_id="LOC_LANTERN_WASTE"),
        EventNode(id="EVT_PETER_KILLS_WOLF", fabula_time=13000, syuzhet_index=22,
                  ...
                  description="Peter kills Maugrim the wolf with his sword while Susan, perched in a tree, draws her bow on the second wolf — together they save the camp from Maugrim's pack.", at_location_id="LOC_PROFESSOR_HOUSE"),
        EventNode(id="EVT_EDMUND_RESCUED", fabula_time=14000, syuzhet_index=23,
                  ...
                  description="Aslan's forces rescue Edmund from the Witch just as she prepares to kill him; Lucy administers a single drop of her healing cordial to bring him back from the brink.", at_location_id="LOC_ASLAN_CAMP"),
        EventNode(id="EVT_ASLAN_FREES_STATUES", fabula_time=14500, syuzhet_index=24,
                  ...
                  description="Aslan breathes on the stone statues in the Witch's castle, restoring them to life.", at_location_id="LOC_ASLAN_CAMP"),
        EventNode(id="EVT_WITCH_DEMANDS_EDMUND", fabula_time=15000, syuzhet_index=25,
                  event_type="choice", actor_ids=["ENT_WHITE_WITCH"], target_ids=["ENT_EDMUND"],
                  description="The Witch confronts Aslan, invoking the Deep Magic that grants her Edmund's life as a traitor.", at_location_id="LOC_WITCH_CASTLE"),
        EventNode(id="EVT_ASLAN_PACT", fabula_time=16000, syuzhet_index=27,
                  ...
                  description="Aslan privately agrees to a secret compromise with the Witch; he grows sad and withdrawn.", at_location_id="LOC_ASLAN_CAMP"),
        EventNode(id="EVT_ASLAN_DEATH", fabula_time=17000, syuzhet_index=29,
                  ...
                  description="The Witch and her followers — chief among them her Dwarf, who shaves Aslan's mane and binds him — kill Aslan at the Stone Table; Susan and Lucy witness in hiding.", at_location_id="LOC_WITCH_CASTLE"),
        EventNode(id="EVT_ASLAN_RESURRECTION", fabula_time=18000, syuzhet_index=30,
                  event_type="outcome", actor_ids=[], target_ids=["ENT_ASLAN"],
                  description="Aslan rises from death by the Deeper Magic; the Stone Table cracks and he returns triumphant.", at_location_id="LOC_STONE_TABLE"),
        EventNode(id="EVT_BATTLE", fabula_time=19000, syuzhet_index=31,
                  ...
                  description="Aslan leads his army to join Peter and Edmund's forces in the great battle.", at_location_id="LOC_ASLAN_CAMP"),
        EventNode(id="EVT_WITCH_KILLED", fabula_time=20000, syuzhet_index=32,
                  ...
                  description="Aslan kills the White Witch in battle, ending her reign over Narnia.", at_location_id="LOC_ASLAN_CAMP"),
        EventNode(id="EVT_CORONATION", fabula_time=21000, syuzhet_index=33,
                  ...
                  description="The four Pevensie children are crowned as Kings and Queens of Narnia at Cair Paravel.", at_location_id="LOC_CAIR_PARAVEL"),
        ...
        EventNode(id="EVT_UTT_TUMNUS_CONFESSION", event_type="utterance",
                  ...
                  at_location_id="LOC_TUMNUS_CAVE", speaker_id="ENT_TUMNUS", addressee_ids=["ENT_LUCY"],
        ...
        EventNode(id="EVT_UTT_WITCH_TEMPTS_EDMUND", event_type="utterance",
                  ...
                  at_location_id="LOC_WITCH_CASTLE", speaker_id="ENT_WHITE_WITCH", addressee_ids=["ENT_EDMUND"],
        ...
        EventNode(id="EVT_UTT_BEAVERS_PROPHECY", event_type="utterance",
                  ...
                  at_location_id="LOC_BEAVERS_DAM", speaker_id="ENT_MR_BEAVER", addressee_ids=["ENT_LUCY", "ENT_PETER", "ENT_SUSAN"],
        ...
        EventNode(id="EVT_UTT_EDMUND_WARNS_WITCH", event_type="utterance",
                  ...
                  at_location_id="LOC_LANTERN_WASTE", speaker_id="ENT_EDMUND", addressee_ids=["ENT_WHITE_WITCH"],
        ...
        EventNode(id="EVT_UTT_WITCH_CLAIMS_EDMUND", event_type="utterance",
                  ...
                  at_location_id="LOC_WITCH_CASTLE", speaker_id="ENT_WHITE_WITCH", addressee_ids=["ENT_ASLAN"],
        ...
        EventNode(id="EVT_UTT_ASLAN_SECRET_PACT", event_type="utterance",
                  ...
                  at_location_id="LOC_ASLAN_CAMP", speaker_id="ENT_ASLAN", addressee_ids=["ENT_WHITE_WITCH"],
    ...
    propositions=[
        ...
        Proposition(proposition_id="PROP_WITCH_RULES_NARNIA", kind="trait_holds",
                    referent_ids=["ENT_WHITE_WITCH", "WORLD_ENCHANTED_WINTER"],
        ...
        Proposition(proposition_id="PROP_NARNIA_FREED", kind="outcome",
                    referent_ids=["WORLD_ENCHANTED_WINTER", "ENT_ASLAN", "LOC_LANTERN_WASTE"],
