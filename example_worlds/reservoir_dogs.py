...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_HEIST_PLANNED", fabula_time=1000, syuzhet_index=1,
                  ...
                  description="Joe Cabot and Eddie assemble six experienced robbers — strangers to each other — under colour-coded aliases to rob Karina's Diamond Store.", at_location_id="LOC_JOE_OFFICE"),
        EventNode(id="EVT_DINER_BREAKFAST", fabula_time=2000, syuzhet_index=2,
                  ...
                  target_ids=[],
                  description="The crew has breakfast at Uncle Bob's; the tipping debate exposes Pink's stinginess and the precarious cohesion of strangers.", at_location_id="LOC_WAREHOUSE"),
        EventNode(id="EVT_HEIST_GOES_WRONG", fabula_time=3000, syuzhet_index=3,
                  ...
                  description="A silent alarm trips; Blonde starts murdering bystanders; police arrive immediately and Brown is killed in the getaway.", at_location_id="LOC_DIAMOND_STORE"),
        EventNode(id="EVT_ORANGE_SHOT", fabula_time=4000, syuzhet_index=4,
                  event_type="outcome",
                  actor_ids=[],
                  target_ids=["ENT_ORANGE"],
                  description="Hijacking a car, Orange is shot in the abdomen by the panicked civilian driver; he kills her in return and bleeds out across the back seat as White drives him to the warehouse.", at_location_id="LOC_ORANGE_CAR"),
        EventNode(id="EVT_WAREHOUSE_REGROUP", fabula_time=5000, syuzhet_index=5,
                  event_type="choice",
                  actor_ids=["ENT_WHITE", "ENT_PINK"],
                  target_ids=["ENT_ORANGE"],
                  description="White and Pink regroup at the warehouse; Pink declares the job a setup and refuses to call a doctor; the two draw on each other before Blonde arrives with a kidnapped cop.", at_location_id="LOC_ORANGE_CAR"),
        EventNode(id="EVT_BLONDE_TORTURES_COP", fabula_time=6000, syuzhet_index=6,
                  event_type="choice",
                  actor_ids=["ENT_BLONDE"],
                  target_ids=["ENT_MARVIN"],
                  description="Left alone with Marvin Nash, Blonde slashes the cop's face and severs his ear with a straight razor while 'Stuck in the Middle with You' plays on the radio, and prepares to set him on fire.", at_location_id="LOC_WAREHOUSE"),
        EventNode(id="EVT_ORANGE_KILLS_BLONDE", fabula_time=7000, syuzhet_index=7,
                  event_type="choice",
                  actor_ids=["ENT_ORANGE"],
                  target_ids=["ENT_BLONDE"],
                  description="Bleeding Orange empties his pistol into Blonde to save Nash, breaking cover for the audience and revealing his loyalties to the cop he was protecting.", at_location_id="LOC_ORANGE_CAR"),
        EventNode(id="EVT_BLUE_KILLED_OFFSCREEN", fabula_time=7500, syuzhet_index=8,
                  event_type="outcome",
                  actor_ids=[],
                  target_ids=["ENT_BLUE"],
                  description="Mr Blue is killed by the police in flight from the heist — reported by Joe at the warehouse, never shown.", at_location_id="LOC_DIAMOND_STORE"),
        EventNode(id="EVT_EDDIE_KILLS_NASH", fabula_time=7600, syuzhet_index=9,
                  event_type="choice",
                  actor_ids=["ENT_EDDIE"],
                  target_ids=["ENT_MARVIN"],
                  description="Returning to the warehouse, Eddie executes the wounded cop to silence him, refusing to believe Orange's story that Blonde planned to murder them.", at_location_id="LOC_JOE_OFFICE"),
        EventNode(id="EVT_MEXICAN_STANDOFF", fabula_time=8000, syuzhet_index=10,
                  event_type="outcome",
                  actor_ids=["ENT_JOE", "ENT_EDDIE", "ENT_WHITE"],
                  target_ids=["ENT_ORANGE"],
                  description="Joe arrives, names Orange as the rat, and goes to execute him; White intervenes at gunpoint; Eddie aims at White; all three fire and Joe, Eddie, and (mortally) White fall.", at_location_id="LOC_WAREHOUSE"),
        EventNode(id="EVT_ORANGE_REVEALED", fabula_time=9000, syuzhet_index=11,
                  event_type="outcome",
                  actor_ids=["ENT_ORANGE"],
                  target_ids=["ENT_WHITE"],
                  description="Cradled in White's arms, the dying Orange confesses that he is an undercover police officer, retroactively reframing every act of paternal tenderness.", at_location_id="LOC_ORANGE_CAR"),
        EventNode(id="EVT_WHITE_KILLS_ORANGE", fabula_time=10000, syuzhet_index=12,
                  event_type="choice",
                  actor_ids=["ENT_WHITE"],
                  target_ids=["ENT_ORANGE"],
                  description="As LAPD storm the warehouse, White presses his pistol to Orange's head and pulls the trigger — and is cut down by police gunfire in the same beat.", at_location_id="LOC_WAREHOUSE"),
        ...
        EventNode(
            ...
            at_location_id="LOC_JOE_OFFICE", content="Joe outlines the diamond-store target, his vetted six-man roster, and the rule that nobody uses real names — only Mr White, Blonde, Orange, Pink, Brown, Blue.",
        ),
        EventNode(
            ...
            at_location_id="LOC_WAREHOUSE", content="Pink orders White to leave Orange bleeding rather than break protocol by summoning a hospital before Joe arrives.",
        ),
        EventNode(
            ...
            at_location_id="LOC_JOE_OFFICE", content="Joe accuses Orange of being an undercover police officer who fed the LAPD the heist plan and got Brown and Blue killed.",
        ),
        EventNode(
            ...
            at_location_id="LOC_ORANGE_CAR", content="Orange tells White, 'I'm a cop, Larry. I'm so sorry,' confirming Joe's accusation.",
        ),
        ...
        EventNode(
            ...
            at_location_id="LOC_ORANGE_CAR", content="I'm a cop. The police will be here when Joe shows up — hold on.",
        ),
        ...
        EventNode(
            ...
            at_location_id="LOC_WAREHOUSE", content="I knew who you were. I wasn't going to give you up.",
        ),
    ],
