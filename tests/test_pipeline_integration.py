    ...
    return WorldStateV1(
        ...
        objects={
            "OBJ_KEY": NarrativeObject(
                ...
                affordances=[Affordance(action="unlock", target_id="LOC_B", target_type="Door")],
            ),
        },
        entities={
            "ENT_ALICE": Entity(
        ...
        events=[
            ...
            EventNode(id="EVT_AFTERMATH", fabula_time=2, syuzhet_index=2,
                      event_type="outcome", actor_id="ENT_BOB",
                      description="Bob flees Room B"),
        ],
        causal_topology=[
            # Strong cause: explosion → Bob
            CausalEdge(source_event_id="EVT_TRIGGER",
            ...
            CausalEdge(source_event_id="EVT_AFTERMATH",
    ...
    return WorldStateV1(
        ...
        events=[
            ...
            EventNode(id="EVT_MURDER", fabula_time=1, syuzhet_index=5,
                      event_type="choice", actor_id="ENT_SUSPECT",
                      target_id="ENT_DETECTIVE",
