...
world_state = WorldStateV1(
    ...
    events=[
        ...
        EventNode(id="EVT_WILLIAM_MURDERED", fabula_time=6, syuzhet_index=6, event_type="choice", actor_id="ENT_CREATURE", target_id="ENT_WILLIAM", description="Embittered, the creature travels to Geneva and kills Victor's younger brother William, then frames Justine."),
        ...
        EventNode(id="EVT_HENRY_MURDERED", fabula_time=11, syuzhet_index=11, event_type="choice", actor_id="ENT_CREATURE", target_id="ENT_HENRY", description="The creature murders Henry Clerval in revenge for Victor destroying the female."),
        ...
        EventNode(id="EVT_ELIZABETH_MURDERED", fabula_time=13, syuzhet_index=13, event_type="choice", actor_id="ENT_CREATURE", target_id="ENT_ELIZABETH", description="Victor marries Elizabeth. Fulfilling his threat, the creature murders her on the wedding night."),
    ...
    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_event_id="EVT_CREATION", target_node_id="EVT_CREATURE_FLEES", mechanism="psychological", fabula_time=1),
        CausalEdge(source_event_id="EVT_CREATURE_LEARNS_ORIGIN", target_node_id="EVT_REJECTED_BY_FAMILY", mechanism="social", fabula_time=3),
        CausalEdge(source_event_id="EVT_REJECTED_BY_FAMILY", target_node_id="EVT_GIRL_RESCUE_SHOOTING", mechanism="social", fabula_time=4),
        CausalEdge(source_event_id="EVT_GIRL_RESCUE_SHOOTING", target_node_id="EVT_WILLIAM_MURDERED", mechanism="psychological", fabula_time=5),
        CausalEdge(source_event_id="EVT_WILLIAM_MURDERED", target_node_id="EVT_JUSTINE_EXECUTED", mechanism="epistemic", fabula_time=6),
        CausalEdge(source_event_id="EVT_JUSTINE_EXECUTED", target_node_id="EVT_CREATURE_DEMANDS_MATE", mechanism="psychological", fabula_time=7),
        CausalEdge(source_event_id="EVT_CREATURE_DEMANDS_MATE", target_node_id="EVT_FEMALE_DESTROYED", mechanism="psychological", fabula_time=8),
        CausalEdge(source_event_id="EVT_FEMALE_DESTROYED", target_node_id="EVT_CREATURE_WARNING", mechanism="psychological", fabula_time=9),
        CausalEdge(source_event_id="EVT_FEMALE_DESTROYED", target_node_id="EVT_HENRY_MURDERED", mechanism="psychological", fabula_time=9),
        CausalEdge(source_event_id="EVT_HENRY_MURDERED", target_node_id="EVT_VICTOR_BREAKDOWN", mechanism="psychological", fabula_time=11),
        CausalEdge(source_event_id="EVT_CREATURE_WARNING", target_node_id="EVT_ELIZABETH_MURDERED", mechanism="physical", fabula_time=10),
        CausalEdge(source_event_id="EVT_ELIZABETH_MURDERED", target_node_id="EVT_ALPHONSE_DIES", mechanism="psychological", fabula_time=13),
        CausalEdge(source_event_id="EVT_ALPHONSE_DIES", target_node_id="EVT_ARCTIC_PURSUIT", mechanism="psychological", fabula_time=14),
        CausalEdge(source_event_id="EVT_ARCTIC_PURSUIT", target_node_id="EVT_WALTON_RESCUE", mechanism="physical", fabula_time=15),
        CausalEdge(source_event_id="EVT_WALTON_RESCUE", target_node_id="EVT_VICTOR_DIES", mechanism="physical", fabula_time=16),
        CausalEdge(source_event_id="EVT_VICTOR_DIES", target_node_id="EVT_CREATURE_MOURNS", mechanism="psychological", fabula_time=17),
    ],
