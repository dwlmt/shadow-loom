...
world_state = WorldStateV1(
    ...
    events=[
        ...
        EventNode(id="EVT_MRS_JOE_ATTACKED", fabula_time=6, syuzhet_index=6, event_type="outcome", actor_id="ENT_ORLICK", target_id="ENT_MRS_JOE", description="Orlick attacks Mrs Joe with the convict's leg iron, leaving her unable to speak or work."),
        ...
        EventNode(id="EVT_ORLICK_AMBUSH", fabula_time=16, syuzhet_index=16, event_type="choice", actor_id="ENT_ORLICK", target_id="ENT_PIP", description="Orlick lures Pip to the sluice-house, confesses to attacking Mrs Joe, and attempts to murder Pip. Herbert and Startop rescue him."),
    ...
    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_event_id="EVT_CONVICT_ENCOUNTER", target_node_id="EVT_PIP_STEALS_FOOD", mechanism="psychological", fabula_time=1),
        CausalEdge(source_event_id="EVT_PIP_STEALS_FOOD", target_node_id="EVT_CONVICT_RECAPTURED", mechanism="physical", fabula_time=2),
        CausalEdge(source_event_id="EVT_SATIS_HOUSE_VISITS", target_node_id="EVT_ESTELLA_IN_SOCIETY", mechanism="social", fabula_time=4),
        CausalEdge(source_event_id="EVT_SATIS_HOUSE_VISITS", target_node_id="EVT_PIP_APPRENTICED", mechanism="social", fabula_time=4),
        CausalEdge(source_event_id="EVT_PIP_STEALS_FOOD", target_node_id="EVT_GREAT_EXPECTATIONS", mechanism="psychological", fabula_time=2),
        CausalEdge(source_event_id="EVT_PIP_GOES_TO_LONDON", target_node_id="EVT_PIP_ASHAMED_OF_JOE", mechanism="psychological", fabula_time=8),
        CausalEdge(source_event_id="EVT_GREAT_EXPECTATIONS", target_node_id="EVT_BENEFACTOR_REVEALED", mechanism="epistemic", fabula_time=7),
        CausalEdge(source_event_id="EVT_BENEFACTOR_REVEALED", target_node_id="EVT_COMPEYSON_IDENTITY", mechanism="epistemic", fabula_time=11),
        CausalEdge(source_event_id="EVT_BENEFACTOR_REVEALED", target_node_id="EVT_HAVISHAM_REMORSE", mechanism="psychological", fabula_time=11),
        CausalEdge(source_event_id="EVT_HAVISHAM_REMORSE", target_node_id="EVT_ESTELLA_PARENTAGE", mechanism="epistemic", fabula_time=14),
        CausalEdge(source_event_id="EVT_BENEFACTOR_REVEALED", target_node_id="EVT_ESCAPE_ATTEMPT", mechanism="social", fabula_time=11),
        CausalEdge(source_event_id="EVT_MAGWITCH_CAPTURED", target_node_id="EVT_MAGWITCH_DIES", mechanism="physical", fabula_time=18),
        CausalEdge(source_event_id="EVT_MAGWITCH_DIES", target_node_id="EVT_PIP_FALLS_ILL", mechanism="psychological", fabula_time=19),
        CausalEdge(source_event_id="EVT_PIP_FALLS_ILL", target_node_id="EVT_BIDDY_MARRIES_JOE", mechanism="social", fabula_time=20),
        CausalEdge(source_event_id="EVT_BIDDY_MARRIES_JOE", target_node_id="EVT_PIP_TO_CAIRO", mechanism="psychological", fabula_time=21),
        CausalEdge(source_event_id="EVT_PIP_TO_CAIRO", target_node_id="EVT_REUNION_ESTELLA", mechanism="social", fabula_time=22),
    ],
