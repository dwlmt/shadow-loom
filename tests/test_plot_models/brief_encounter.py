...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_GRIT_IN_EYE", fabula_time=1, syuzhet_index=3, event_type="outcome", actor_ids=["ENT_ALEC"], description="Alec removes a piece of grit from Laura's eye at the station, charming her."),
        EventNode(id="EVT_WEEKLY_MEETINGS", fabula_time=2, syuzhet_index=4, event_type="outcome", actor_ids=[], description="Laura and Alec begin meeting on Thursdays — first casually at the chemist, then lunch and films."),
        EventNode(id="EVT_LOVE_ADMITTED", fabula_time=3, syuzhet_index=5, event_type="revelation", actor_ids=[], description="Laura and Alec admit they love each other, despite both being married with children."),
        EventNode(id="EVT_FRIENDS_SPOTTED", fabula_time=4, syuzhet_index=6, event_type="outcome", actor_ids=[], description="They run into Laura's friends in public, forcing the first of many deceptions."),
        EventNode(id="EVT_STEPHEN_FLAT_ATTEMPT", fabula_time=5, syuzhet_index=7, event_type="choice", actor_ids=["ENT_ALEC"], description="Laura and Alec agree to make love at Stephen's flat, but Stephen returns unexpectedly and subtly chides Alec."),
        EventNode(id="EVT_LAURA_WANDERS", fabula_time=6, syuzhet_index=8, event_type="outcome", actor_ids=["ENT_LAURA"], description="Distraught Laura wanders the streets for three hours until a police officer urges her home."),
        EventNode(id="EVT_RELATIONSHIP_UNWORKABLE", fabula_time=7, syuzhet_index=9, event_type="revelation", actor_ids=[], description="Laura and Alec admit their relationship is unworkable."),
        EventNode(id="EVT_ALEC_TAKES_JOB", fabula_time=8, syuzhet_index=10, event_type="choice", actor_ids=["ENT_ALEC"], description="For his family's sake, Alec decides to end the relationship by taking a job in Johannesburg."),
        EventNode(id="EVT_FINAL_MEETING", fabula_time=9, syuzhet_index=1, event_type="outcome", actor_ids=[], description="Laura and Alec have their final meeting in the refreshment room. Dolly Messiter interrupts them."),
        EventNode(id="EVT_ALEC_DEPARTS", fabula_time=10, syuzhet_index=2, event_type="outcome", actor_ids=["ENT_ALEC"], description="Alec's train arrives before a proper goodbye. He discreetly squeezes Laura's shoulder and departs."),
        EventNode(id="EVT_SUICIDE_ATTEMPT", fabula_time=11, syuzhet_index=11, event_type="choice", actor_ids=["ENT_LAURA"], description="Overcome with emotion, Laura nearly jumps in front of an express train but gathers herself."),
        EventNode(id="EVT_LAURA_RETURNS_HOME", fabula_time=12, syuzhet_index=12, event_type="outcome", actor_ids=["ENT_LAURA"], description="Laura returns home. Fred acknowledges her distance and thanks her for coming back. She weeps in his arms."),
    ],

    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_id="EVT_GRIT_IN_EYE", target_id="EVT_WEEKLY_MEETINGS", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=1),
        CausalEdge(source_id="EVT_WEEKLY_MEETINGS", target_id="EVT_LOVE_ADMITTED", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=2),
        CausalEdge(source_id="EVT_LOVE_ADMITTED", target_id="EVT_FRIENDS_SPOTTED", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=3),
        CausalEdge(source_id="EVT_LOVE_ADMITTED", target_id="EVT_STEPHEN_FLAT_ATTEMPT", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=3),
        CausalEdge(source_id="EVT_STEPHEN_FLAT_ATTEMPT", target_id="EVT_LAURA_WANDERS", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=5),
        CausalEdge(source_id="EVT_LAURA_WANDERS", target_id="EVT_RELATIONSHIP_UNWORKABLE", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=6),
        CausalEdge(source_id="EVT_RELATIONSHIP_UNWORKABLE", target_id="EVT_ALEC_TAKES_JOB", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=7),
        CausalEdge(source_id="EVT_ALEC_TAKES_JOB", target_id="EVT_FINAL_MEETING", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=8),
        CausalEdge(source_id="EVT_FINAL_MEETING", target_id="EVT_ALEC_DEPARTS", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=9),
        CausalEdge(source_id="EVT_ALEC_DEPARTS", target_id="EVT_SUICIDE_ATTEMPT", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=10),
        CausalEdge(source_id="EVT_SUICIDE_ATTEMPT", target_id="EVT_LAURA_RETURNS_HOME", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=11),
    ],
