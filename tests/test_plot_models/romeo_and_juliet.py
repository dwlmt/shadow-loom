...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_STREET_BRAWL", fabula_time=1, syuzhet_index=1, event_type="outcome", actor_id=None, description="A street brawl erupts between Montague and Capulet servants. Prince Escalus declares further breaches punishable by death."),
        EventNode(id="EVT_CAPULET_BALL", fabula_time=2, syuzhet_index=2, event_type="outcome", actor_id=None, description="Romeo attends the Capulet ball hoping to see Rosaline but instead meets and falls in love with Juliet."),
        EventNode(id="EVT_BALCONY_SCENE", fabula_time=3, syuzhet_index=3, event_type="choice", actor_id="ENT_ROMEO", description="Romeo sneaks into the Capulet orchard; he and Juliet vow their love and agree to marry."),
        EventNode(id="EVT_SECRET_MARRIAGE", fabula_time=4, syuzhet_index=4, event_type="choice", actor_id="ENT_FRIAR_LAURENCE", description="Friar Laurence secretly marries Romeo and Juliet, hoping to reconcile the families."),
        EventNode(id="EVT_TYBALT_CHALLENGES_ROMEO", fabula_time=5, syuzhet_index=5, event_type="choice", actor_id="ENT_TYBALT", description="Tybalt challenges Romeo to a duel. Romeo refuses since Tybalt is now his kinsman."),
        EventNode(id="EVT_MERCUTIO_KILLED", fabula_time=6, syuzhet_index=6, event_type="outcome", actor_id="ENT_TYBALT", description="Mercutio accepts the duel on Romeo's behalf and is fatally wounded when Romeo tries to intervene."),
        EventNode(id="EVT_TYBALT_KILLED", fabula_time=7, syuzhet_index=7, event_type="choice", actor_id="ENT_ROMEO", description="Grief-stricken Romeo confronts and slays Tybalt."),
        EventNode(id="EVT_ROMEO_EXILED", fabula_time=8, syuzhet_index=8, event_type="outcome", actor_id="ENT_PRINCE_ESCALUS", description="Prince Escalus exiles Romeo from Verona under penalty of death."),
        EventNode(id="EVT_CONSUMMATION", fabula_time=9, syuzhet_index=9, event_type="choice", actor_id="ENT_ROMEO", description="Romeo secretly spends the night in Juliet's chamber; they consummate their marriage."),
        EventNode(id="EVT_PARIS_BETROTHAL", fabula_time=10, syuzhet_index=10, event_type="choice", actor_id="ENT_CAPULET", description="Lord Capulet agrees to marry Juliet to Count Paris and threatens to disown her when she refuses."),
        EventNode(id="EVT_SLEEPING_POTION", fabula_time=11, syuzhet_index=11, event_type="choice", actor_id="ENT_FRIAR_LAURENCE", description="Friar Laurence gives Juliet a potion to simulate death for 42 hours and plans to inform Romeo."),
