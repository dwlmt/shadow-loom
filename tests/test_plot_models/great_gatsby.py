...
world_state = WorldStateV1(
    ...
    events=[
        EventNode(id="EVT_NICK_ARRIVES", fabula_time=1, syuzhet_index=1, event_type="outcome", actor_ids=["ENT_NICK"], description="Nick Carraway arrives in West Egg, renting a bungalow next to Gatsby's mansion."),
        EventNode(id="EVT_DINNER_EAST_EGG", fabula_time=2, syuzhet_index=2, event_type="outcome", actor_ids=["ENT_NICK"], description="Nick dines with Daisy and Tom in East Egg. Jordan reveals Tom has a mistress."),
        EventNode(id="EVT_GATSBY_STARES_GREEN_LIGHT", fabula_time=3, syuzhet_index=3, event_type="outcome", actor_ids=["ENT_GATSBY"], description="Nick sees Gatsby standing alone staring at the green light across the bay."),
        EventNode(id="EVT_TOM_MYRTLE_PARTY", fabula_time=4, syuzhet_index=4, event_type="outcome", actor_ids=["ENT_TOM"], description="Tom takes Nick to the Valley of Ashes; party in the New York apartment ends with Tom breaking Myrtle's nose."),
        EventNode(id="EVT_GATSBY_PARTY", fabula_time=5, syuzhet_index=5, event_type="outcome", actor_ids=["ENT_GATSBY"], description="Nick attends Gatsby's lavish party and meets Gatsby, who claims they served together in the war."),
        EventNode(id="EVT_JORDAN_REVEALS_PAST", fabula_time=6, syuzhet_index=6, event_type="revelation", actor_ids=["ENT_JORDAN"], description="Jordan reveals that Gatsby and Daisy were in love in 1917 and that Gatsby's parties are all for her."),
        EventNode(id="EVT_GATSBY_DAISY_REUNION", fabula_time=7, syuzhet_index=7, event_type="choice", actor_ids=["ENT_GATSBY"], description="Gatsby uses Nick to stage a reunion with Daisy. They begin an affair."),
        EventNode(id="EVT_TOM_DISCOVERS_AFFAIR", fabula_time=8, syuzhet_index=8, event_type="revelation", actor_ids=["ENT_TOM"], description="Tom discovers Gatsby and Daisy's affair when Daisy addresses Gatsby with unguarded intimacy."),
        EventNode(id="EVT_PLAZA_CONFRONTATION", fabula_time=9, syuzhet_index=9, event_type="outcome", actor_ids=["ENT_TOM"], description="At the Plaza Hotel, Tom and Gatsby argue. Tom reveals Gatsby's bootlegging. Daisy chooses to stay with Tom."),
        EventNode(id="EVT_MYRTLE_KILLED", fabula_time=10, syuzhet_index=10, event_type="outcome", actor_ids=["ENT_DAISY"], target_ids=["ENT_MYRTLE"], description="Driving back from the Plaza, Daisy (driving Gatsby's car) strikes and kills Myrtle Wilson."),
        EventNode(id="EVT_GATSBY_TAKES_BLAME", fabula_time=11, syuzhet_index=11, event_type="choice", actor_ids=["ENT_GATSBY"], description="Gatsby tells Nick that Daisy was driving but he intends to take the blame."),
        EventNode(id="EVT_TOM_TELLS_GEORGE", fabula_time=12, syuzhet_index=12, event_type="choice", actor_ids=["ENT_TOM"], description="Tom tells George Wilson that the car that killed Myrtle belongs to Gatsby."),
        EventNode(id="EVT_GATSBY_MURDERED", fabula_time=13, syuzhet_index=13, event_type="outcome", actor_ids=["ENT_GEORGE"], target_ids=["ENT_GATSBY"], description="George shoots Gatsby in his pool, then kills himself, believing Gatsby was Myrtle's lover and killer."),
        EventNode(id="EVT_FUNERAL", fabula_time=14, syuzhet_index=14, event_type="outcome", actor_ids=[], description="Gatsby's funeral is sparsely attended. His father Henry Gatz arrives."),
        EventNode(id="EVT_NICK_LEAVES", fabula_time=15, syuzhet_index=15, event_type="choice", actor_ids=["ENT_NICK"], description="Nick, disillusioned, decides to leave New York and return to the Midwest."),
    ],

    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_id="EVT_NICK_ARRIVES", target_id="EVT_DINNER_EAST_EGG", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=1),
        CausalEdge(source_id="EVT_DINNER_EAST_EGG", target_id="EVT_GATSBY_STARES_GREEN_LIGHT", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=2),
        CausalEdge(source_id="EVT_GATSBY_PARTY", target_id="EVT_JORDAN_REVEALS_PAST", causality_type="chain_reaction", mechanism="epistemic", evidence_strength="moderate", causal_force=5.0, fabula_time=5),
        CausalEdge(source_id="EVT_JORDAN_REVEALS_PAST", target_id="EVT_GATSBY_DAISY_REUNION", causality_type="chain_reaction", mechanism="epistemic", evidence_strength="moderate", causal_force=5.0, fabula_time=6),
        CausalEdge(source_id="EVT_GATSBY_DAISY_REUNION", target_id="EVT_TOM_DISCOVERS_AFFAIR", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=7),
        CausalEdge(source_id="EVT_TOM_DISCOVERS_AFFAIR", target_id="EVT_PLAZA_CONFRONTATION", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=8),
        CausalEdge(source_id="EVT_PLAZA_CONFRONTATION", target_id="EVT_MYRTLE_KILLED", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=9),
        CausalEdge(source_id="EVT_MYRTLE_KILLED", target_id="EVT_GATSBY_TAKES_BLAME", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=10),
        CausalEdge(source_id="EVT_MYRTLE_KILLED", target_id="EVT_TOM_TELLS_GEORGE", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=10),
        CausalEdge(source_id="EVT_TOM_TELLS_GEORGE", target_id="EVT_GATSBY_MURDERED", causality_type="chain_reaction", mechanism="epistemic", evidence_strength="moderate", causal_force=5.0, fabula_time=12),
        CausalEdge(source_id="EVT_GATSBY_MURDERED", target_id="EVT_FUNERAL", causality_type="chain_reaction", mechanism="social", evidence_strength="moderate", causal_force=5.0, fabula_time=13),
        CausalEdge(source_id="EVT_FUNERAL", target_id="EVT_NICK_LEAVES", causality_type="chain_reaction", mechanism="psychological", evidence_strength="moderate", causal_force=5.0, fabula_time=14),
    ],
