...
world_state = WorldStateV1(
    ...
    events=[
        ...
        EventNode(id="EVT_DUNCAN_MURDER", fabula_time=6, syuzhet_index=6, event_type="choice", actor_id="ENT_MACBETH", target_id="ENT_DUNCAN", description="Macbeth stabs King Duncan to death in his sleep at Inverness Castle."),
        ...
        EventNode(id="EVT_MACBETH_KILLS_SERVANTS", fabula_time=8, syuzhet_index=8, event_type="choice", actor_id="ENT_MACBETH", target_id="ENT_DUNCAN", description="Macbeth impulsively kills Duncan's servants to prevent them from professing innocence."),
        ...
        EventNode(id="EVT_BANQUO_MURDERED", fabula_time=11, syuzhet_index=11, event_type="choice", actor_id="ENT_MACBETH", target_id="ENT_BANQUO", description="Macbeth hires murderers who kill Banquo, but Fleance escapes."),
        ...
        EventNode(id="EVT_MACDUFF_FAMILY_SLAUGHTERED", fabula_time=14, syuzhet_index=14, event_type="choice", actor_id="ENT_MACBETH", target_id="ENT_MACDUFF", description="Macbeth orders assassins to slaughter Macduff's wife and children at Fife."),
        ...
        EventNode(id="EVT_MACBETH_KILLED", fabula_time=19, syuzhet_index=19, event_type="outcome", actor_id="ENT_MACDUFF", target_id="ENT_MACBETH", description="Macduff, born by Caesarean section, kills Macbeth in single combat, fulfilling the prophecy."),
    ...
    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_event_id="EVT_REBELLION_DEFEATED", target_node_id="EVT_CAWDOR_TITLE", mechanism="social", fabula_time=1),
        CausalEdge(source_event_id="EVT_WITCHES_PROPHECY_1", target_node_id="EVT_LETTER_SENT", mechanism="psychological", fabula_time=2),
        CausalEdge(source_event_id="EVT_CAWDOR_TITLE", target_node_id="EVT_LETTER_SENT", mechanism="epistemic", fabula_time=3),
        CausalEdge(source_event_id="EVT_LADY_MACBETH_PERSUADES", target_node_id="EVT_DUNCAN_MURDER", mechanism="psychological", fabula_time=5),
        CausalEdge(source_event_id="EVT_DUNCAN_MURDER", target_node_id="EVT_SERVANTS_FRAMED", mechanism="physical", fabula_time=6),
        CausalEdge(source_event_id="EVT_DUNCAN_MURDER", target_node_id="EVT_MACBETH_KILLS_SERVANTS", mechanism="psychological", fabula_time=6),
        CausalEdge(source_event_id="EVT_DUNCAN_MURDER", target_node_id="EVT_SONS_FLEE", mechanism="psychological", fabula_time=6),
        CausalEdge(source_event_id="EVT_SONS_FLEE", target_node_id="EVT_MACBETH_CROWNED", mechanism="social", fabula_time=9),
        CausalEdge(source_event_id="EVT_WITCHES_PROPHECY_1", target_node_id="EVT_BANQUO_MURDERED", mechanism="psychological", fabula_time=2),
        CausalEdge(source_event_id="EVT_BANQUO_MURDERED", target_node_id="EVT_BANQUO_GHOST", mechanism="psychological", fabula_time=11),
        CausalEdge(source_event_id="EVT_WITCHES_PROPHECY_2", target_node_id="EVT_MACDUFF_FAMILY_SLAUGHTERED", mechanism="psychological", fabula_time=13),
        CausalEdge(source_event_id="EVT_MACDUFF_FAMILY_SLAUGHTERED", target_node_id="EVT_MALCOLM_MACDUFF_ALLIANCE", mechanism="psychological", fabula_time=14),
        CausalEdge(source_event_id="EVT_DUNCAN_MURDER", target_node_id="EVT_LADY_MACBETH_SLEEPWALKING", mechanism="psychological", fabula_time=6),
        CausalEdge(source_event_id="EVT_LADY_MACBETH_SLEEPWALKING", target_node_id="EVT_LADY_MACBETH_DEATH", mechanism="psychological", fabula_time=16),
        CausalEdge(source_event_id="EVT_MALCOLM_MACDUFF_ALLIANCE", target_node_id="EVT_BIRNAM_WOOD_MOVES", mechanism="physical", fabula_time=15),
        CausalEdge(source_event_id="EVT_BIRNAM_WOOD_MOVES", target_node_id="EVT_MACBETH_KILLED", mechanism="physical", fabula_time=17),
        CausalEdge(source_event_id="EVT_MACBETH_KILLED", target_node_id="EVT_MALCOLM_CROWNED", mechanism="social", fabula_time=19),
    ],
