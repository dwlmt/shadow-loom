...
world_state = WorldStateV1(
    ...
    events=[
        ...
        EventNode(id="EVT_JACQUELINE_SHOOTS_SIMON", fabula_time=6, syuzhet_index=6, event_type="choice", actor_id="ENT_JACQUELINE", target_id="ENT_SIMON", description="In the lounge, Jacqueline pretends to drunkenly shoot Simon. She deliberately misses; Simon fakes a leg injury with red ink."),
        EventNode(id="EVT_SIMON_MURDERS_LINNET", fabula_time=7, syuzhet_index=7, event_type="choice", actor_id="ENT_SIMON", target_id="ENT_LINNET", description="While Jacqueline distracts Fanthorp and Cornelia, Simon takes the pistol, goes to Linnet's cabin, and shoots her dead."),
        EventNode(id="EVT_SIMON_SHOOTS_SELF", fabula_time=8, syuzhet_index=8, event_type="choice", actor_id="ENT_SIMON", target_id="ENT_SIMON", description="Simon returns to the lounge, shoots himself in the leg for real, wraps the pistol in the velvet stole, and throws it overboard."),
        ...
        EventNode(id="EVT_LOUISE_MURDERED", fabula_time=12, syuzhet_index=12, event_type="choice", actor_id="ENT_JACQUELINE", target_id="ENT_LOUISE", description="Jacqueline stabs Louise to death to protect Simon from blackmail."),
        EventNode(id="EVT_MRS_OTTERBOURNE_MURDERED", fabula_time=13, syuzhet_index=13, event_type="choice", actor_id="ENT_JACQUELINE", target_id="ENT_MRS_OTTERBOURNE", description="Mrs Otterbourne sees Jacqueline entering Louise's cabin. When she tries to tell Poirot, Simon alerts Jacqueline, who shoots her dead."),
        ...
        EventNode(id="EVT_MURDER_SUICIDE", fabula_time=19, syuzhet_index=19, event_type="choice", actor_id="ENT_JACQUELINE", target_id="ENT_SIMON", description="As the steamer arrives at Shellal, Jacqueline shoots Simon and herself with a second pistol to escape the gallows."),
    ],

    # ── CAUSAL TOPOLOGY ────────────────────────────────────────────────────
    causal_topology=[
        CausalEdge(source_event_id="EVT_POIROT_MEETS_LINNET", target_node_id="EVT_BOARDING_KARNAK", mechanism="social", fabula_time=1),
        CausalEdge(source_event_id="EVT_BOARDING_KARNAK", target_node_id="EVT_BOULDER_ATTACK", mechanism="social", fabula_time=3),
        CausalEdge(source_event_id="EVT_POIROT_MEETS_LINNET", target_node_id="EVT_POIROT_WARNS_JACQUELINE", mechanism="psychological", fabula_time=1),
        CausalEdge(source_event_id="EVT_BOARDING_KARNAK", target_node_id="EVT_RACE_BOARDS", mechanism="social", fabula_time=3),
        CausalEdge(source_event_id="EVT_JACQUELINE_SHOOTS_SIMON", target_node_id="EVT_SIMON_MURDERS_LINNET", mechanism="physical", fabula_time=6),
        CausalEdge(source_event_id="EVT_SIMON_MURDERS_LINNET", target_node_id="EVT_SIMON_SHOOTS_SELF", mechanism="physical", fabula_time=7),
        CausalEdge(source_event_id="EVT_SIMON_MURDERS_LINNET", target_node_id="EVT_PEARLS_STOLEN", mechanism="social", fabula_time=7),
        CausalEdge(source_event_id="EVT_SIMON_MURDERS_LINNET", target_node_id="EVT_LINNET_FOUND_DEAD", mechanism="physical", fabula_time=7),
        CausalEdge(source_event_id="EVT_SIMON_MURDERS_LINNET", target_node_id="EVT_LOUISE_BLACKMAIL", mechanism="epistemic", fabula_time=7),
        CausalEdge(source_event_id="EVT_LOUISE_BLACKMAIL", target_node_id="EVT_LOUISE_MURDERED", mechanism="psychological", fabula_time=11),
        CausalEdge(source_event_id="EVT_LOUISE_MURDERED", target_node_id="EVT_MRS_OTTERBOURNE_MURDERED", mechanism="epistemic", fabula_time=12),
        CausalEdge(source_event_id="EVT_POIROT_REVEALS_TRUTH", target_node_id="EVT_SIMON_CONFESSES", mechanism="epistemic", fabula_time=17),
        CausalEdge(source_event_id="EVT_BOULDER_ATTACK", target_node_id="EVT_POIROT_CONFRONTS_PENNINGTON", mechanism="epistemic", fabula_time=4),
        CausalEdge(source_event_id="EVT_PEARLS_STOLEN", target_node_id="EVT_TIM_EXPOSED", mechanism="epistemic", fabula_time=9),
        CausalEdge(source_event_id="EVT_SIMON_CONFESSES", target_node_id="EVT_MURDER_SUICIDE", mechanism="psychological", fabula_time=18),
    ],
