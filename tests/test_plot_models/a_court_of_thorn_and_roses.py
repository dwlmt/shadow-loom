...
world_state = WorldStateV1(
    ...
    events=[
        ...
        EventNode(id="EVT_RHYSAND_THREATENS", fabula_time=5, syuzhet_index=5, event_type="outcome", actor_id="ENT_RHYSAND", description="Rhysand visits the Spring Court. Tamlin decides Feyre is no longer safe and sends her home."),
        EventNode(id="EVT_TAMLIN_FEYRE_LOVE", fabula_time=6, syuzhet_index=6, event_type="outcome", actor_id=None, description="Tamlin and Feyre make love and declare their feelings, but Feyre cannot say 'I love you' aloud."),
        EventNode(id="EVT_FEYRE_RETURNS_HOME", fabula_time=7, syuzhet_index=7, event_type="outcome", actor_id="ENT_FEYRE", description="Feyre returns to find her family wealthy (Tamlin's doing). Nesta reveals the glamour didn't work on her."),
        EventNode(id="EVT_FEYRE_RETURNS_PRYTHIAN", fabula_time=8, syuzhet_index=8, event_type="choice", actor_id="ENT_FEYRE", description="Inspired by Nesta's words, Feyre returns to Prythian to fight alongside Tamlin."),
        EventNode(id="EVT_ALIS_REVEALS_TRUTH", fabula_time=9, syuzhet_index=9, event_type="revelation", actor_id="ENT_ALIS", description="Alis reveals the blight is Amarantha. The curse requires a woman who hates fae to declare love for Tamlin. The curse wasn't broken."),
        EventNode(id="EVT_FEYRE_ENTERS_MOUNTAIN", fabula_time=10, syuzhet_index=10, event_type="choice", actor_id="ENT_FEYRE", description="Feyre journeys Under the Mountain to rescue Tamlin and Lucien."),
        EventNode(id="EVT_TASK_ONE", fabula_time=11, syuzhet_index=11, event_type="outcome", actor_id="ENT_FEYRE", description="Feyre escapes a giant worm in a labyrinth. Rhysand bets on her and heals her broken arm."),
