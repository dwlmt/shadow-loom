...
class TestDramaticIronyScore:
    ...
    def test_irony_zero_when_character_aware(self):
        ...
        ws = WorldStateV1(
            ...
            causal_topology=[
                CausalEdge(source_event_id="EVT_THREAT",
                           target_node_id="ENT_A",
        ...
        return WorldStateV1(
            ...
            events=[
                ...
                EventNode(id="EVT_ATTACK", fabula_time=2, syuzhet_index=3,
                          event_type="choice", actor_id="ENT_VILLAIN",
                          target_id="ENT_HERO",
                ...
                EventNode(id="EVT_ESCAPE", fabula_time=3, syuzhet_index=4,
                          event_type="choice", actor_id="ENT_HERO",
                          description="The hero finds a way out"),
            ],
            causal_topology=[
                # Strong causal edge from setup to attack
                CausalEdge(source_event_id="EVT_REVEALED",
                           target_node_id="EVT_ATTACK",
                           mechanism="physical", evidence_strength="strong",
                           fabula_time=1),
            ],
            spatial_topology=[],
        ...
        ws = WorldStateV1(
            ...
            events=[
                ...
                EventNode(id="EVT_DOOM", fabula_time=2, syuzhet_index=2,
                          event_type="outcome", actor_id="ENT_VILLAIN",
                          target_id="ENT_X",
                          description="Doom"),
            ],
            causal_topology=[],
    ...
    def test_kl_divergence_increases_with_trait_extremity(self):
        ...
        def _make_ws(val):
            return WorldStateV1(
                ...
                causal_topology=[
                    CausalEdge(source_event_id="EVT_X",
                               target_node_id="ENT_A",
                               mechanism="physical", evidence_strength="strong",
                               fabula_time=1),
                ],
